...
public class RazonamientoDeductivoTest {
    ...
    private RazonamientoDeductivo rd;

    public RazonamientoDeductivoTest(double pd_total, double percentil_esperado,
