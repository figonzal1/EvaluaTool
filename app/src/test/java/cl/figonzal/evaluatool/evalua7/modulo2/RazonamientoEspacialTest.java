...
public class RazonamientoEspacialTest {
    ...
    private RazonamientoEspacial re;

    public RazonamientoEspacialTest(double pd_total, double percentil_esperado,
