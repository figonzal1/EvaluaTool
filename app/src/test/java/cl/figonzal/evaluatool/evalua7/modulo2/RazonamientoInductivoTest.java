...
public class RazonamientoInductivoTest {
    ...
    private RazonamientoInductivo ri;

    public RazonamientoInductivoTest(double pd_total, double percentil_esperado,
