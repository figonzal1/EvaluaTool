...
import cl.figonzal.evaluatool.evalua.evalua6.modulo3.adaptacionFragments.AutoEstimaFragmentE6M3
...
class AutoEstimaFragmentE6M3Test(
    ...
    private var m1: AutoEstimaFragmentE6M3? = null

    @Before
    fun setUp() {
        m1 = AutoEstimaFragmentE6M3()
    }
