...
class ClasificacionesE1M2Test(private val pd_total: Double, private val percentil_esperado: Double,
                              private val desviacion_esperada: Double) {
    private var m1: ClasificacionesE1M2? = null

    @Before
    fun setUp() {
        m1 = ClasificacionesE1M2()
    }
