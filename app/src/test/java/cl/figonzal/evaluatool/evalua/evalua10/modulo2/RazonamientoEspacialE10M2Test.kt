...
class RazonamientoEspacialE10M2Test(
    private val pd_total: Int, private val percentil_esperado: Double,
    private val desviacion_esperada: Double
) {
    private var m1: RazonamientoEspacialE10M2? = null

    @Before
    fun setUp() {
        m1 = RazonamientoEspacialE10M2()
    }
    ...
    companion object {
        ...
        fun data(): Array<Array<Any>> {
            return razonamientoEspacialE10M2Baremo()
        }
    }
}
