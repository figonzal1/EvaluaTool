...
class OrganizacionPerceptivaE3M2Test(private val pd_total: Double, private val percentil_esperado: Double, private val desviacion_esperada: Double) {
    private var m1: OrganizacionPerceptivaE3M2? = null

    @Before
    fun setUp() {
        m1 = OrganizacionPerceptivaE3M2()
    }
    ...
    companion object {
        ...
        fun data(): Array<Array<Any>> {
            return organizacionPerceptivaE3M2Baremo()
        }
    }
}