...
import cl.figonzal.evaluatool.baremosTables.conductaProsocialE5M3Baremo
import cl.figonzal.evaluatool.evalua.evalua5.modulo3.adaptacionFragments.ConductaProSocialFragmentE5M3
...
class ConductaProSocialFragmentE5M3Test(
    ...
    private var m1: ConductaProSocialFragmentE5M3? = null

    @Before
    fun setUp() {
        m1 = ConductaProSocialFragmentE5M3()
    }
    ...
    companion object {
        ...
        fun data(): Array<Array<Any>> {
            return conductaProsocialE5M3Baremo()
        }
    }
}