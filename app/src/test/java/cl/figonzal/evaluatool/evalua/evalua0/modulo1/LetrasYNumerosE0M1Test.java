...
public class LetrasYNumerosE0M1Test {
    ...
    private LetrasYNumerosE0M1 m1;

    public LetrasYNumerosE0M1Test(double pd_total, double percentil_esperado,
