...
public class CalculoNumeracionE7M6Test {
    ...
    private CalculoNumeracionE7M6 cn;

    public CalculoNumeracionE7M6Test(double pd_total, double percentil_esperado,
