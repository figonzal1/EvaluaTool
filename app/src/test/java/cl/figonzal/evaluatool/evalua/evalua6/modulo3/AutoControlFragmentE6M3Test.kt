...
import cl.figonzal.evaluatool.evalua.evalua6.modulo3.adaptacionFragments.AutoControlFragmentE6M3
...
class AutoControlFragmentE6M3Test(
    ...
    private var m1: AutoControlFragmentE6M3? = null

    @Before
    fun setUp() {
        m1 = AutoControlFragmentE6M3()
    }
