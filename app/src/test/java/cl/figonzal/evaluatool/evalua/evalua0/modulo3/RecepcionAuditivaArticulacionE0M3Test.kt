...
class RecepcionAuditivaArticulacionE0M3Test(private val pd_total: Double, private val percentil_esperado: Double,
                                            private val desviacion_esperada: Double) {
    private var m1: RecepcionAuditivaArticulacionE0M3? = null

    @Before
    fun setUp() {
        m1 = RecepcionAuditivaArticulacionE0M3()
    }
