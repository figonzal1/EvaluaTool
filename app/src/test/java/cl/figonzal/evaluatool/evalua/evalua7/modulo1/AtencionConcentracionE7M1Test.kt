...
class AtencionConcentracionE7M1Test(private val pd_total: Double, private val percentil_esperado: Double,
                                    private val desviacion_esperada: Double) {
    private var m1: AtencionConcentracionE7M1? = null

    @Before
    fun setUp() {
        m1 = AtencionConcentracionE7M1()
    }
