...
import cl.figonzal.evaluatool.baremosTables.motivacionE4M3Baremo
...
class MotivacionFragmentE4M3Test(private val pd_total: Double, private val percentil_esperado: Double,
                                 private val desviacion_esperada: Double) {
    private var m1: MotivacionFragmentE4M3? = null

    @Before
    fun setUp() {
        m1 = MotivacionFragmentE4M3()
    }
