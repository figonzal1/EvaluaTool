...
class ComprensionLectoraE6M4Test(
    private val pd_total: Int, private val percentil_esperado: Double,
    private val desviacion_esperada: Double
) {
    private var m1: ComprensionLectoraE6M4? = null

    @Before
    fun setUp() {
        m1 = ComprensionLectoraE6M4()
    }
    ...
    companion object {
        ...
        fun data(): Array<Array<Any>> {
            return comprensionLectoraE6M4Baremo()
        }
    }
}
