...
class MemoriaAtencionE3M1Test(private val pd_total: Double, private val percentil_esperado: Double, private val desviacion_esperada: Double) {
    private var m1: MemoriaAtencionE3M1? = null

    @Before
    fun setUp() {
        m1 = MemoriaAtencionE3M1()
    }
