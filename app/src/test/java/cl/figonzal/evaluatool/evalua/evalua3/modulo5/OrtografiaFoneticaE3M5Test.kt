...
class OrtografiaFoneticaE3M5Test(private val pd_total: Double, private val percentil_esperado: Double, private val desviacion_esperada: Double) {
    private var m1: OrtografiaFoneticaE3M5? = null

    @Before
    fun setUp() {
        m1 = OrtografiaFoneticaE3M5()
    }
