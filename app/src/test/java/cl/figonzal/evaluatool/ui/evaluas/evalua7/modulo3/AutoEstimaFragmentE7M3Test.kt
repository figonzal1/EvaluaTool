...
class AutoEstimaFragmentE7M3Test : KoinTest {
    ...
    fun setUp() {
        startKoin {
            ...
            modules(
                module {
                    single<BaremoTable> { Evalua7Baremo() }
                }
            )
        }

        perc = baremoTable.getBaremo(Evalua7Constants.AUTO_ESTIMA_FRAGMENT_E7M3)
    }
