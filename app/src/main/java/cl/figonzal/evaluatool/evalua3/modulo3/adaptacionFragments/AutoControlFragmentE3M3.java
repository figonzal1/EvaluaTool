...
public class AutoControlFragmentE3M3 extends Fragment implements EvaluaInterface {

    private static final double DESVIACION = 3.49;
    private static final double MEDIA = 4.02;
    ...
    public AutoControlFragmentE3M3() {
    }

    public static AutoControlFragmentE3M3 newInstance() {
        return new AutoControlFragmentE3M3();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_auto_control_e3_m3, container, false);
