...
public class ComprensionLectora extends AppCompatActivity implements EvaluaInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_comprension_lectora2);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        if (item.getItemId() == android.R.id.home) {
            ...
            Crashlytics.log(Log.DEBUG, getString(R.string.TAG_COMPR_LECTURA), getString(R.string.ACTIVIDAD_CERRADA));
