...
public class MemoriaAtencionE3M1 extends AppCompatActivity implements EvaluaInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_memoria_atencion_e3_m1);
