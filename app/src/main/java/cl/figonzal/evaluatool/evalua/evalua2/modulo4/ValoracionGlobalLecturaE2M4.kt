...
import cl.figonzal.evaluatool.databinding.ActivityValoracionGlobalLecturaE2M4Binding
...
class ValoracionGlobalLecturaE2M4 : AppCompatActivity(), IndiceValorInterface {

    private lateinit var binding: ActivityValoracionGlobalLecturaE2M4Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityValoracionGlobalLecturaE2M4Binding.inflate(layoutInflater)
    ...
    private fun initResources() {
        ...
        with(binding, {
            this@ValoracionGlobalLecturaE2M4.etTotalesT1 = etTotalesT1
            this@ValoracionGlobalLecturaE2M4.etTotalesT2 = etTotalesT2

            //SUBTOTAL
            tvSubTotalT1 = tvPdSubtotalT1
            tvSubTotalT2 = tvPdSubtotalT2
            //TOTAL
            this@ValoracionGlobalLecturaE2M4.tvPdTotal = tvPdTotalValue
        }).also {
            textWatcherTarea1()
        }
    }
