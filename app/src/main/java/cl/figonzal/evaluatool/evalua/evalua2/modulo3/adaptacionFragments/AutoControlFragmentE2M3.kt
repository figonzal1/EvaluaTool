...
class AutoControlFragmentE2M3 : Fragment(), EvaluaInterface {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val v = inflater.inflate(R.layout.fragment_auto_control_e2_m3, container, false)
    ...
    private fun instanciarRecursosInterfaz(v: View) {
        ...
        Utilidades.configurarTextoBaremo(requireFragmentManager(), tvBaremo, perc, getString(R.string.TOOLBAR_AUTOCONTROL))
