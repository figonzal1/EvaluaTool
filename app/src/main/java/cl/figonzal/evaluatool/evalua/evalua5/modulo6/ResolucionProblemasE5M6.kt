...
class ResolucionProblemasE5M6 : AppCompatActivity(), EvaluaInterface {
    ...
    private fun instanciarRecursosInterfaz() {
        ...
        Utilidades.configurarTextoBaremo(supportFragmentManager, tvBaremo, perc, getString(R.string.TOOLBAR_RESOLUCION_PROBLEMAS))
    ...
    private fun textWatcherTarea1() {
        ...
        etAprobadasT1.addTextChangedListener(object : TextWatcher {
            ...
            override fun afterTextChanged(s: Editable) {
                ...
                totalPdT1 = calcularTarea(1, tvSubTotalT1, "Tareas 1: ", aprobadasT1, null, null)
                calcularResultado()
            }
        })
    }
    ...
    private fun textWatcherTarea2() {
        ...
        etAprobadasT2.addTextChangedListener(object : TextWatcher {
            ...
            override fun afterTextChanged(s: Editable) {
                ...
                totalPdT2 = calcularTarea(2, tvSubTotalT2, "Tareas 2: ", aprobadasT2, null, null)
                calcularResultado()
            }
        })
    }
