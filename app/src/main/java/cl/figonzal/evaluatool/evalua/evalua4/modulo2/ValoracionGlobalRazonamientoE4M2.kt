...
class ValoracionGlobalRazonamientoE4M2 : AppCompatActivity(), IndiceValorInterface {
    private lateinit var binding: ActivityValoracionGlobalRazonamientoE4M2Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityValoracionGlobalRazonamientoE4M2Binding.inflate(layoutInflater)
    ...
    private fun initResources() {
        ...
        with(binding, {
            this@ValoracionGlobalRazonamientoE4M2.etTotalesT1 = etTotalesT1
            this@ValoracionGlobalRazonamientoE4M2.etTotalesT2 = etTotalesT2
            this@ValoracionGlobalRazonamientoE4M2.etTotalesT3 = etTotalesT3
            ...
            //TOTAL
            this@ValoracionGlobalRazonamientoE4M2.tvPdTotal = tvPdTotalValue
        }).run {
            textWatcherTarea1()
        }
    }
        ...
        with(etTotalesT1) {
            addTextChangedListener(object : TextWatcher {
                ...
                override fun afterTextChanged(s: Editable) {
                    ...
                    tvSubTotalT1.text = String.format(getString(R.string.POINTS_SIMPLE_FORMAT), "RE: ", subTotalT1)
                    calculateResult()
                }
            })
        }
        with(etTotalesT2) {
            addTextChangedListener(object : TextWatcher {
                ...
                override fun afterTextChanged(s: Editable) {
                    ...
                    tvSubTotalT2.text = String.format(getString(R.string.POINTS_SIMPLE_FORMAT), "PA: ", subTotalT2)
                    calculateResult()
                }
            })
        }
        ...
        with(etTotalesT3) {
            addTextChangedListener(object : TextWatcher {
                ...
                override fun afterTextChanged(s: Editable) {
                    ...
                    tvSubTotalT3.text = String.format(getString(R.string.POINTS_SIMPLE_FORMAT), "OP: ", subTotalT3)
                    calculateResult()
                }
            })
        }
