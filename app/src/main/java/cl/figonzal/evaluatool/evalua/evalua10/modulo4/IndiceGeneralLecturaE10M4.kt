...
import cl.figonzal.evaluatool.databinding.ActivityIndiceGeneralLecturaE10M4Binding
...
class IndiceGeneralLecturaE10M4 : AppCompatActivity(), IndiceValorInterface {
    private lateinit var binding: ActivityIndiceGeneralLecturaE10M4Binding
    ...
    private fun initResources() {
        ...
        with(binding, {
            this@IndiceGeneralLecturaE10M4.etTotalesT1 = etTotalesT1
            this@IndiceGeneralLecturaE10M4.etTotalesT2 = etTotalesT2

            //SUBTOTAL
            tvSubTotalT1 = tvPdSubtotalT1
            tvSubTotalT2 = tvPdSubtotalT2
            //TOTAL
            this@IndiceGeneralLecturaE10M4.tvPdTotal = tvPdTotalValue
        }).also {
            textWatcherTarea1()
        }
    }
        ...
        with(etTotalesT2) {
            addTextChangedListener(object : TextWatcher {
                ...
                override fun afterTextChanged(s: Editable) {
                    ...
                    tvSubTotalT2.text =
                        String.format(getString(R.string.POINTS_FORMAT), "VL: ", subTotalT2)
                    calculateResult()
                }
            })
        }
