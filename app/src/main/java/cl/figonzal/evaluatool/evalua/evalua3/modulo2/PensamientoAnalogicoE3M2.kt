...
class PensamientoAnalogicoE3M2 : AppCompatActivity(), EvaluaInterface {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        actionBar.title = getString(R.string.TOOLBAR_PENSAMIENTO_ANALOGICO)
    ...
    private fun instanciarRecursosInterfaz() {
        ...
        EvaluaUtils.configurarTextoBaremo(supportFragmentManager, tvBaremo, perc, getString(R.string.TOOLBAR_PENSAMIENTO_ANALOGICO))
