...
import cl.figonzal.evaluatool.baremosTables.adaptacionEscolarE9M3Baremo
...
class AdaptacionEscolarFragmentE9M3 : Fragment(), EvaluaInterface {

    companion object {

        private const val MEDIA = 27.83
    ...
    private var binding: FragmentAdaptacionEscolarE9M3Binding? = null
    private val perc = adaptacionEscolarE9M3Baremo()
    ...
    override fun onCreateView(
        ...
        binding = FragmentAdaptacionEscolarE9M3Binding.inflate(inflater, container, false)
    ...
    private fun initResources(binding: FragmentAdaptacionEscolarE9M3Binding) {
        ...
        with(binding, {
            ...
            this@AdaptacionEscolarFragmentE9M3.etAprobadasT1 = etAprobadasT1

            //TOTAL
            this@AdaptacionEscolarFragmentE9M3.tvPdTotal = tvPdTotalValue
            tvPdCorregido = tvPdTotalCorregidoValue
            this@AdaptacionEscolarFragmentE9M3.tvPercentil = tvPercentilValue
