...
public class ValoracionGlobalLectoraE4M4 extends AppCompatActivity implements IndiceValorInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_valoracion_global_lectora_e4_m4);
