...
class OrtografiaFoneticaE3M5 : AppCompatActivity(), EvaluaInterface {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_ortografia_fonetica_e3_m5)
    ...
    private fun instanciarRecursosInterfaz() {
        ...
        Utilidades.configurarTextoBaremo(supportFragmentManager, tvBaremo, perc, getString(R.string.TOOLBAR_ORTOGRAFIA_FONETICA))
