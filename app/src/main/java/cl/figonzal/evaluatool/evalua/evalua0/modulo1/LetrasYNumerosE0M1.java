...
public class LetrasYNumerosE0M1 extends AppCompatActivity implements EvaluaInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.setTitle(getString(R.string.TOOLBAR_LETRAS_NUMEROS));
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        if (item.getItemId() == android.R.id.home) {
            ...
            Log.d(getString(R.string.TAG_LETRAS_NUMEROS), getString(R.string.ACTIVIDAD_CERRADA));

            crashlytics.log(getString(R.string.TAG_LETRAS_NUMEROS) + getString(R.string.ACTIVIDAD_CERRADA));
