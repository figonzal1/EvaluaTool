...
import cl.figonzal.evaluatool.resolvers.evalua6.modulo3.ConductaProSocialFragmentE6M3Resolver.Companion.DEVIATION
import cl.figonzal.evaluatool.resolvers.evalua6.modulo3.ConductaProSocialFragmentE6M3Resolver.Companion.MEAN
...
class ConductaProSocialFragmentE6M3 : Fragment() {
    ...
    private fun initResources(binding: FragmentConductaProSocialE6M3Binding) {
        ...
        with(binding, {
            ...
            this@ConductaProSocialFragmentE6M3.etApprovedT1 = etAprobadasT1
