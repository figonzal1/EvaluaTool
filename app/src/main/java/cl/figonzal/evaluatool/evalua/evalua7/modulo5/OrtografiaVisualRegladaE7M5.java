...
public class OrtografiaVisualRegladaE7M5 extends AppCompatActivity implements EvaluaInterface {
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        if (item.getItemId() == android.R.id.home) {
            ...
            crashlytics.log(getString(R.string.TAG_ORT_VIS_REGLADA) + getString(R.string.ACTIVIDAD_CERRADA));
