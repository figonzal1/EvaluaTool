...
class IndiceGeneralCognitivoE2M1 : AppCompatActivity(), IndiceValorInterface {
    ...
    private fun initResources() {
        ...
        with(binding, {
            this@IndiceGeneralCognitivoE2M1.etTotalesT1 = etTotalesT1
            this@IndiceGeneralCognitivoE2M1.etTotalesT2 = etTotalesT2
            this@IndiceGeneralCognitivoE2M1.etTotalesT3 = etTotalesT3
        ...
        with(etTotalesT1) {
            addTextChangedListener(object : TextWatcher {
                ...
                override fun afterTextChanged(s: Editable) {
                    ...
                    tvSubTotalT1.text =
                        String.format(getString(R.string.POINTS_FORMAT), "PA: ", subTotalT1)
                    calculateResult()
                }
            })
        }
        with(etTotalesT2) {
            addTextChangedListener(object : TextWatcher {
                ...
                override fun afterTextChanged(s: Editable) {
                    ...
                    tvSubTotalT2.text =
                        String.format(getString(R.string.POINTS_FORMAT), "CA: ", subTotalT2)
                    calculateResult()
                }
            })
        }
