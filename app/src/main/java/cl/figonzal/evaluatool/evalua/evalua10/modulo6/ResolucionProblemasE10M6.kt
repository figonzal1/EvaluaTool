...
import cl.figonzal.evaluatool.databinding.ActivityResolucionProblemasE10M6Binding
import cl.figonzal.evaluatool.resolvers.evalua10.modulo6.ResolucionProblemasE10M6Resolver
import cl.figonzal.evaluatool.resolvers.evalua10.modulo6.ResolucionProblemasE10M6Resolver.Companion.DESVIACION
import cl.figonzal.evaluatool.resolvers.evalua10.modulo6.ResolucionProblemasE10M6Resolver.Companion.MEDIA
import cl.figonzal.evaluatool.utilidades.*
import com.google.android.material.progressindicator.LinearProgressIndicator
import com.google.android.material.textfield.TextInputEditText

class ResolucionProblemasE10M6 : AppCompatActivity() {

    private lateinit var binding: ActivityResolucionProblemasE10M6Binding
    ...
    private val resolver by lazy {
        ResolucionProblemasE10M6Resolver()
    }

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityResolucionProblemasE10M6Binding.inflate(layoutInflater)
    ...
    private fun initResources() {
        ...
        with(binding, {
            ...
            this@ResolucionProblemasE10M6.etAprobadasT1 = etAprobadasT1

            //TOTALES
            this@ResolucionProblemasE10M6.tvPdTotal = tvPdTotalValue
