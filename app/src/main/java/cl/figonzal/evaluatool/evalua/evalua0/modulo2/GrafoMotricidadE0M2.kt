...
import cl.figonzal.evaluatool.resolvers.evalua0.modulo2.CopiaDibujosE0M2Resolver.Companion.DEVIATION
import cl.figonzal.evaluatool.resolvers.evalua0.modulo2.GrafoMotricidadE0M2Resolver
import cl.figonzal.evaluatool.resolvers.evalua0.modulo2.GrafoMotricidadE0M2Resolver.Companion.MEAN
...
class GrafoMotricidadE0M2 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        configureActionBar(R.string.TOOLBAR_GRAFOMOTRICIDAD, binding.includeToolbar.materialToolbar)
    ...
    private fun initResources() {
        ...
        with(binding) {
            ...
            this@GrafoMotricidadE0M2.etReprobateT1 = etReprobadasT1
