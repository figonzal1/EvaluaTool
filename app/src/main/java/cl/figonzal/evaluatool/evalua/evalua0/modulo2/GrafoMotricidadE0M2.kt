...
class GrafoMotricidadE0M2 : AppCompatActivity(), EvaluaInterface {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        configActionBar(R.string.TOOLBAR_GRAFOMOTRICIDAD, binding.include.toolbar)
    ...
    private fun initResources() {
        ...
        with(binding, {
            ...
            Utils.configurarTextoBaremo(supportFragmentManager, tablaBaremo.tvBaremo, perc, getString(R.string.TOOLBAR_GRAFOMOTRICIDAD))
        }).run {
            textWatcherTarea1()
        }
    }
