...
import cl.figonzal.evaluatool.databinding.ActivityValoracionGlobalBasesE3M2Binding
...
class ValoracionGlobalBasesE3M2 : AppCompatActivity(), IndiceValorInterface {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityValoracionGlobalBasesE3M2Binding.inflate(layoutInflater)
    ...
    private fun initResources() {
        ...
        with(binding, {
            ...
            //TOTAL
            this@ValoracionGlobalBasesE3M2.tvPdTotal = tvPdTotalValue
        }).also {
            textWatcherTarea1()
        }
    }
