...
class ConductaProSocialE1M3 : Fragment(), EvaluaInterface {
    ...
    private lateinit var binding: FragmentConductaProSocialE1M3Binding
     ...
     */
    private fun instanciarRecursosInterfaz(binding: FragmentConductaProSocialE1M3Binding) {
