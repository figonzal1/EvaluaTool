...
class ReflexividadE4M2 : AppCompatActivity(), EvaluaInterface {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_reflexividad_e4_m2)
    ...
    private fun instanciarRecursosInterfaz() {
        ...
        Utilidades.configurarTextoBaremo(supportFragmentManager, tvBaremo, perc, getString(R.string.TOOLBAR_REFLEXIVIDAD))
