...
import cl.figonzal.evaluatool.resolvers.evalua7.modulo3.ConductaProSocialFragmentE7M3Resolver.Companion.DEVIATION
import cl.figonzal.evaluatool.resolvers.evalua7.modulo3.ConductaProSocialFragmentE7M3Resolver.Companion.MEAN
...
class ConductaProSocialFragmentE7M3 : Fragment() {
    ...
    private fun initResources(binding: FragmentConductaProSocialE7M3Binding) {
        ...
        with(binding) {
            ...
            this@ConductaProSocialFragmentE7M3.etApprovedT1 = etAprobadasT1
