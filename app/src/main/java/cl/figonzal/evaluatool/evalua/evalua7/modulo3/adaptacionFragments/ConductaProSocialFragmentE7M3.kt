...
import cl.figonzal.evaluatool.baremosTables.conductaProSocialFragmentE7M3Baremo
...
class ConductaProSocialFragmentE7M3 : Fragment(), EvaluaInterface {
    ...
    private val perc = conductaProSocialFragmentE7M3Baremo()
    ...
    private fun initResources(binding: FragmentConductaProSocialE7M3Binding) {
        ...
        with(binding, {
            ...
            Utils.configurarTextoBaremo(
                parentFragmentManager, tablaBaremo.tvBaremo, perc, getString(
