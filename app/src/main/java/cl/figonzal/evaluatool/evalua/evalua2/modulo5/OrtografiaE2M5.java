...
public class OrtografiaE2M5 extends AppCompatActivity implements EvaluaInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ortografia_e2_m5);
        ...
        actionBar.setTitle(getString(R.string.TOOLBAR_ORTOGRAFIA));
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        if (item.getItemId() == android.R.id.home) {
            ...
            Log.d(getString(R.string.TAG_ORTOGRAFIA), getString(R.string.ACTIVIDAD_CERRADA));

            crashlytics.log(getString(R.string.TAG_ORTOGRAFIA) + getString(R.string.ACTIVIDAD_CERRADA));
