...
class OrtografiaE2M5 : AppCompatActivity(), EvaluaInterface {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        actionBar.title = getString(R.string.TOOLBAR_ORTOGRAFIA)
    ...
    private fun instanciarRecursosInterfaz() {
        ...
        Utils.configurarTextoBaremo(supportFragmentManager, tvBaremo, perc, getString(R.string.TOOLBAR_ORTOGRAFIA))
