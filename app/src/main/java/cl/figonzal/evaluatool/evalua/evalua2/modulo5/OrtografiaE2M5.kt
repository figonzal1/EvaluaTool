...
class OrtografiaE2M5 : AppCompatActivity(), EvaluaInterface {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        configActionBar(R.string.TOOLBAR_ORTOGRAFIA, binding.include.toolbar)
    ...
    private fun initResources() {
        ...
        with(binding, {
            ...
            this@OrtografiaE2M5.etAprobadasT1 = etAprobadasT1
            tvSubTotalT2 = tvPdSubtotalT2
            this@OrtografiaE2M5.etReprobadasT2 = etReprobadasT2
            ...
            Utils.configurarTextoBaremo(supportFragmentManager, tablaBaremo.tvBaremo, perc, getString(R.string.TOOLBAR_ORTOGRAFIA))
        }).run {
            textWatcherTarea1()
            textWatcherTarea2()
        }
