...
import cl.figonzal.evaluatool.databinding.ActivityCalculoNumeracionE8M6Binding
import cl.figonzal.evaluatool.resolvers.evalua8.modulo6.CalculoNumeracionE8M6Resolver
import cl.figonzal.evaluatool.resolvers.evalua8.modulo6.CalculoNumeracionE8M6Resolver.Companion.DESVIACION
import cl.figonzal.evaluatool.resolvers.evalua8.modulo6.CalculoNumeracionE8M6Resolver.Companion.MEDIA
...
class CalculoNumeracionE8M6 : AppCompatActivity() {

    private lateinit var binding: ActivityCalculoNumeracionE8M6Binding
    ...
    private val resolver by lazy {
        CalculoNumeracionE8M6Resolver()
    }

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityCalculoNumeracionE8M6Binding.inflate(layoutInflater)
    ...
    private fun initResources() {
        ...
        with(binding, {
            ...
            this@CalculoNumeracionE8M6.etAprobadasT1 = etAprobadasT1

            //TOTALES
            this@CalculoNumeracionE8M6.tvPdTotal = tvPdTotalValue
