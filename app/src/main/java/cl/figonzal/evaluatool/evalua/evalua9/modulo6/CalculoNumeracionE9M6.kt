...
import cl.figonzal.evaluatool.databinding.ActivityCalculoNumeracionE9M6Binding
import cl.figonzal.evaluatool.resolvers.evalua9.modulo6.CalculoNumeracionE9M6Resolver
import cl.figonzal.evaluatool.resolvers.evalua9.modulo6.CalculoNumeracionE9M6Resolver.Companion.DESVIACION
import cl.figonzal.evaluatool.resolvers.evalua9.modulo6.CalculoNumeracionE9M6Resolver.Companion.MEDIA
import cl.figonzal.evaluatool.utilities.*
import com.google.android.material.progressindicator.LinearProgressIndicator
import com.google.android.material.textfield.TextInputEditText
import timber.log.Timber

class CalculoNumeracionE9M6 : AppCompatActivity() {

    private lateinit var binding: ActivityCalculoNumeracionE9M6Binding
    ...
    private val resolver by lazy {
        CalculoNumeracionE9M6Resolver()
    }

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityCalculoNumeracionE9M6Binding.inflate(layoutInflater)
    ...
    private fun initResources() {
        ...
        with(binding, {
            ...
            this@CalculoNumeracionE9M6.etAprobadasT1 = etAprobadasT1

            //TOTALES
            this@CalculoNumeracionE9M6.tvPdTotal = tvPdTotalValue
