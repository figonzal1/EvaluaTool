...
import cl.figonzal.evaluatool.resolvers.evalua6.modulo3.MotivacionFragmentE6M3Resolver.Companion.DEVIATION
import cl.figonzal.evaluatool.resolvers.evalua6.modulo3.MotivacionFragmentE6M3Resolver.Companion.MEAN
...
class MotivacionFragmentE6M3 : Fragment() {
    ...
    private fun initResources(binding: FragmentMotivacionE6M3Binding) {
        ...
        with(binding) {
            ...
            this@MotivacionFragmentE6M3.etApprovedT1 = etAprobadasT1
