...
import cl.figonzal.evaluatool.databinding.FragmentMotivacionE6M3Binding
import cl.figonzal.evaluatool.resolvers.evalua6.modulo3.MotivacionFragmentE6M3Resolver
import cl.figonzal.evaluatool.resolvers.evalua6.modulo3.MotivacionFragmentE6M3Resolver.Companion.DESVIACION
import cl.figonzal.evaluatool.resolvers.evalua6.modulo3.MotivacionFragmentE6M3Resolver.Companion.MEDIA
...
class MotivacionFragmentE6M3 : Fragment() {
    ...
    companion object {
        fun newInstance(): MotivacionFragmentE6M3 {
            return MotivacionFragmentE6M3()
        }
    }

    private var binding: FragmentMotivacionE6M3Binding? = null
    ...
    private val resolver by lazy {
        MotivacionFragmentE6M3Resolver()
    }
    ...
    override fun onCreateView(
        ...
        binding = FragmentMotivacionE6M3Binding.inflate(inflater, container, false)
    ...
    private fun initResources(binding: FragmentMotivacionE6M3Binding) {
        ...
        with(binding, {
            ...
            this@MotivacionFragmentE6M3.etAprobadasT1 = etAprobadasT1

            //TOTAL
            this@MotivacionFragmentE6M3.tvPdTotal = tvPdTotalValue
