...
import cl.figonzal.evaluatool.databinding.ActivityResolucionProblemasE6M6Binding
import cl.figonzal.evaluatool.resolvers.evalua6.modulo6.ResolucionProblemasE6M6Resolver
import cl.figonzal.evaluatool.resolvers.evalua6.modulo6.ResolucionProblemasE6M6Resolver.Companion.DESVIACION
import cl.figonzal.evaluatool.resolvers.evalua6.modulo6.ResolucionProblemasE6M6Resolver.Companion.MEDIA
...
class ResolucionProblemasE6M6 : AppCompatActivity() {
    ...
    private lateinit var binding: ActivityResolucionProblemasE6M6Binding
    ...
    private val resolver by lazy {
        ResolucionProblemasE6M6Resolver()
    }

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityResolucionProblemasE6M6Binding.inflate(layoutInflater)
    ...
    private fun initResources() {
        ...
        with(binding, {
            ...
            this@ResolucionProblemasE6M6.etAprobadasT1 = etAprobadasT1

            //TOTALES
            this@ResolucionProblemasE6M6.tvPdTotal = tvPdTotalValue
