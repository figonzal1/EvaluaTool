...
import cl.figonzal.evaluatool.databinding.ActivityIndiceGeneralEscrituraE9M5Binding
...
class IndiceGeneralEscrituraE9M5 : AppCompatActivity(), IndiceValorInterface {
    private lateinit var binding: ActivityIndiceGeneralEscrituraE9M5Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityIndiceGeneralEscrituraE9M5Binding.inflate(layoutInflater)
    ...
    private fun initResources() {
        ...
        with(binding, {
            this@IndiceGeneralEscrituraE9M5.etTotalesT1 = etTotalesT1
