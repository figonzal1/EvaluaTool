...
import cl.figonzal.evaluatool.databinding.FragmentAutoEstimaE7M3Binding
import cl.figonzal.evaluatool.resolvers.evalua7.modulo3.AutoEstimaFragmentE7M3Resolver
import cl.figonzal.evaluatool.resolvers.evalua7.modulo3.AutoEstimaFragmentE7M3Resolver.Companion.DESVIACION
import cl.figonzal.evaluatool.resolvers.evalua7.modulo3.AutoEstimaFragmentE7M3Resolver.Companion.MEDIA
...
class AutoEstimaFragmentE7M3 : Fragment() {

    companion object {
        fun newInstance(): AutoEstimaFragmentE7M3 {
            return AutoEstimaFragmentE7M3()
        }
    }
    ...
    private val resolver by lazy {
        AutoEstimaFragmentE7M3Resolver()
    }
    ...
    private fun initResources(binding: FragmentAutoEstimaE7M3Binding) {
        ...
        with(binding, {
            ...
            this@AutoEstimaFragmentE7M3.etAprobadasT1 = etAprobadasT1

            //TOTAL
            this@AutoEstimaFragmentE7M3.tvPdTotal = tvPdTotalValue
