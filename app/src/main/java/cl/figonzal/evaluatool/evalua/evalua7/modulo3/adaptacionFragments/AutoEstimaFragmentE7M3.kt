...
class AutoEstimaFragmentE7M3 : Fragment(), EvaluaInterface {

    companion object {
        private const val DESVIACION = 4.51
        private const val MEDIA = 11.45
    ...
    private val perc = autoEstimaFragmentE7M3Baremo()
