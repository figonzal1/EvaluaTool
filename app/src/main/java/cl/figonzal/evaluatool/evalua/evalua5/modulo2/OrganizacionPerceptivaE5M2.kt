...
import cl.figonzal.evaluatool.baremosTables.organizacionPerceptivaE5M2Baremo
...
class OrganizacionPerceptivaE5M2 : AppCompatActivity(), EvaluaInterface {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        configActionBar(R.string.TOOLBAR_ORG_PERCEPTIVA, binding.include.materialToolbar)
