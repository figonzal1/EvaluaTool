...
import cl.figonzal.evaluatool.resolvers.evalua5.modulo3.AutoEstimaFragmentE5M3Resolver
import cl.figonzal.evaluatool.resolvers.evalua5.modulo3.AutoEstimaFragmentE5M3Resolver.Companion.DESVIACION
import cl.figonzal.evaluatool.resolvers.evalua5.modulo3.AutoEstimaFragmentE5M3Resolver.Companion.MEDIA
...
class AutoEstimaFragmentE5M3 : Fragment() {
    ...
    private var binding: FragmentAutoEstimaE5M3Binding? = null
    ...
    private val resolver by lazy {
        AutoEstimaFragmentE5M3Resolver()
    }
    ...
    private fun initResources(binding: FragmentAutoEstimaE5M3Binding) {
        ...
        with(binding, {
            ...
            this@AutoEstimaFragmentE5M3.etAprobadasT1 = etAprobadasT1
