...
import cl.figonzal.evaluatool.baremosTables.autoEstimaFragmentE5M3Baremo
...
class AutoEstimaFragmentE5M3 : Fragment(), EvaluaInterface {

    companion object {
        private const val DESVIACION = 3.48
        private const val MEDIA = 5.86
    ...
    private val perc = autoEstimaFragmentE5M3Baremo()
