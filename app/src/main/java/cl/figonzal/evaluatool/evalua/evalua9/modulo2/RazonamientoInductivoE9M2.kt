...
import cl.figonzal.evaluatool.baremosTables.razonamientoInductivoE9M2Baremo
...
class RazonamientoInductivoE9M2 : AppCompatActivity(), EvaluaInterface {
    companion object {
    ...
    override fun calculateTask(
        ...
        var total = floor(
            when (nTarea) {
                ...
                3, 4, 6 -> aprobadas - (reprobadas / 3.0)
                5 -> aprobadas - (reprobadas / 2.0)
                else -> 0.0
            }
        )
