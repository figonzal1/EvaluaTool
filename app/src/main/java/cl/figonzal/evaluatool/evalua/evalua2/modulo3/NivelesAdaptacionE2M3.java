...
import cl.figonzal.evaluatool.evalua.evalua2.modulo3.adaptacionFragments.FragmentPageAdapterE2M3;
...
public class NivelesAdaptacionE2M3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewPager.setAdapter(new FragmentPageAdapterE2M3(getSupportFragmentManager()));
