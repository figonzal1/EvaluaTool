...
import cl.figonzal.evaluatool.databinding.ActivityIndiceGeneralCognitivoE10M2Binding
...
class IndiceGeneralCognitivoE10M2 : AppCompatActivity(), IndiceValorInterface {

    private lateinit var binding: ActivityIndiceGeneralCognitivoE10M2Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityIndiceGeneralCognitivoE10M2Binding.inflate(layoutInflater)
    ...
    private fun initResources() {
        ...
        with(binding, {
            this@IndiceGeneralCognitivoE10M2.etTotalesT1 = etTotalesT1
            this@IndiceGeneralCognitivoE10M2.etTotalesT2 = etTotalesT2
            this@IndiceGeneralCognitivoE10M2.etTotalesT3 = etTotalesT3
            ...
            //TOTAL
            this@IndiceGeneralCognitivoE10M2.tvPdTotal = tvPdTotalValue
        }).also {
            textWatcherTarea1()
        }
    }
        ...
        etTotalesT2.run {
            addTextChangedListener(object : TextWatcher {
                ...
                override fun afterTextChanged(s: Editable) {
                    ...
                    tvSubTotalT2.text = formatResult(R.string.POINTS_FORMAT, "RD:", subTotalT2)
                    calculateResult()
                }
            })
        }
        ...
        etTotalesT3.run {
            addTextChangedListener(object : TextWatcher {
                ...
                override fun afterTextChanged(s: Editable) {
                    ...
                    tvSubTotalT3.text = formatResult(R.string.POINTS_FORMAT, "RE:", subTotalT3)
                    calculateResult()
                }
            })
        }
