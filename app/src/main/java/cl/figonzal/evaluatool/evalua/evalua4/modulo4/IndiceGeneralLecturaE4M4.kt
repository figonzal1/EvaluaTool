...
class IndiceGeneralLecturaE4M4 : AppCompatActivity(), IndiceValorInterface {
    ...
    private fun initResources() {
        ...
        with(binding, {
            this@IndiceGeneralLecturaE4M4.etTotalesT1 = etTotalesT1
            this@IndiceGeneralLecturaE4M4.etTotalesT2 = etTotalesT2
        ...
        with(etTotalesT2) {
            addTextChangedListener(object : TextWatcher {
                ...
                override fun afterTextChanged(s: Editable) {
                    ...
                    tvSubTotalT2.text = String.format(getString(R.string.POINTS_FORMAT), "VL: ", subTotalT2)
                    calculateResult()
                }
            })
        }
