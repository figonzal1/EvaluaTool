        ...
        when {
            ...
            pdActual < perc.last()[0] as Int -> return perc.last()[0] as Int
                ...
                when {
                    ...
                    pdActual - 11 == item.first() -> return item.first() as Int
                    pdActual - 12 == item.first() -> return item.first() as Int
                    pdActual - 13 == item.first() -> return item.first() as Int
                    pdActual - 14 == item.first() -> return item.first() as Int
                    pdActual - 15 == item.first() -> return item.first() as Int
                }
            }
        }
