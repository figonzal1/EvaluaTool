...
class ComprensionLectoraE1M4 : AppCompatActivity(), EvaluaInterface {
    ...
    private fun initResources() {
        ...
        with(binding, {
            ...
            this@ComprensionLectoraE1M4.etAprobadasT1 = etAprobadasT1
            this@ComprensionLectoraE1M4.etOmitidasT1 = etOmitidasT1
            this@ComprensionLectoraE1M4.etReprobadasT1 = etReprobadasT1

            //TAREA 2
            tvSubTotalT2 = tvPdSubtotalT2
            this@ComprensionLectoraE1M4.etAprobadasT2 = etAprobadasT2

            //TAREA 3
            tvSubTotalT3 = tvPdSubtotalT3
            this@ComprensionLectoraE1M4.etAprobadasT3 = etAprobadasT3
        ...
        with(etAprobadasT3) {
            addTextChangedListener(object : TextWatcher {
                ...
                override fun afterTextChanged(s: Editable) {
                    ...
                    subtotalPdT3 = calculateTask(2, tvSubTotalT3, context.getString(R.string.TAREA_3), aprobadasT3, null, null)
                    calculateResult()
                }
            })
        }
    ...
    override fun calculateTask(nTarea: Int?, tvSubTotal: TextView, tarea: String, aprobadas: Int?, omitidas: Int?, reprobadas: Int?): Double {
        ...
        val total = when (nTarea) {
            1 -> floor(aprobadas!! - (reprobadas!! + omitidas!!).toDouble())
