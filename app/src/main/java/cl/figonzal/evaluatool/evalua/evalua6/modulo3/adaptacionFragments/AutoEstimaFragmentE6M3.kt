...
import cl.figonzal.evaluatool.resolvers.evalua6.modulo3.AutoEstimaFragmentE6M3Resolver.Companion.DEVIATION
import cl.figonzal.evaluatool.resolvers.evalua6.modulo3.AutoEstimaFragmentE6M3Resolver.Companion.MEAN
...
class AutoEstimaFragmentE6M3 : Fragment() {
    ...
    private fun initResources(binding: FragmentAutoEstimaE6M3Binding) {
        ...
        with(binding, {
            ...
            this@AutoEstimaFragmentE6M3.etApprovedT1 = etAprobadasT1
