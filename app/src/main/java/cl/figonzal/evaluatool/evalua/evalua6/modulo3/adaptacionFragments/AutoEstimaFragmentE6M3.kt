...
import cl.figonzal.evaluatool.databinding.FragmentAutoEstimaE6M3Binding
import cl.figonzal.evaluatool.resolvers.evalua6.modulo3.AutoEstimaFragmentE6M3Resolver
import cl.figonzal.evaluatool.resolvers.evalua6.modulo3.AutoEstimaFragmentE6M3Resolver.Companion.DESVIACION
import cl.figonzal.evaluatool.resolvers.evalua6.modulo3.AutoEstimaFragmentE6M3Resolver.Companion.MEDIA
import cl.figonzal.evaluatool.utilidades.*
import com.google.android.material.progressindicator.LinearProgressIndicator
import com.google.android.material.textfield.TextInputEditText

class AutoEstimaFragmentE6M3 : Fragment() {

    companion object {
        fun newInstance(): AutoEstimaFragmentE6M3 {
            return AutoEstimaFragmentE6M3()
        }
    }

    private var binding: FragmentAutoEstimaE6M3Binding? = null
    ...
    private val resolver by lazy {
        AutoEstimaFragmentE6M3Resolver()
    }
    ...
    override fun onCreateView(
        ...
        binding = FragmentAutoEstimaE6M3Binding.inflate(inflater, container, false)

        initResources(binding!!)
        return binding!!.root
    }

    private fun initResources(binding: FragmentAutoEstimaE6M3Binding) {
        ...
        with(binding, {
            ...
            this@AutoEstimaFragmentE6M3.etAprobadasT1 = etAprobadasT1

            //TOTAL
            this@AutoEstimaFragmentE6M3.tvPdTotal = tvPdTotalValue
