...
class MotivacionFragmentE1M3 : Fragment(), EvaluaInterface {
    ...
    private lateinit var binding: FragmentMotivacionE1M3Binding
     ...
     */
    private fun instanciarRecursosInterfaz(binding: FragmentMotivacionE1M3Binding) {
        ...
        EvaluaUtils.configurarTextoBaremo(requireFragmentManager(), tvBaremo, perc, getString(R.string.TOOLBAR_MOTIVACION))
