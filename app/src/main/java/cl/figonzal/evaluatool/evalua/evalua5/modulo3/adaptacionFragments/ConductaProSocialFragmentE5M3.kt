...
import cl.figonzal.evaluatool.databinding.FragmentConductaProSociale5M3Binding
import cl.figonzal.evaluatool.resolvers.evalua5.modulo3.ConductaProSocialFragmentE5M3Resolver
import cl.figonzal.evaluatool.resolvers.evalua5.modulo3.ConductaProSocialFragmentE5M3Resolver.Companion.DESVIACION
import cl.figonzal.evaluatool.resolvers.evalua5.modulo3.ConductaProSocialFragmentE5M3Resolver.Companion.MEDIA
import cl.figonzal.evaluatool.utilities.*
import com.google.android.material.progressindicator.LinearProgressIndicator
import com.google.android.material.textfield.TextInputEditText
import java.util.*

class ConductaProSocialFragmentE5M3 : Fragment() {

    companion object {
        fun newInstance(): ConductaProSocialFragmentE5M3 {
            return ConductaProSocialFragmentE5M3()
        }
    }

    private var binding: FragmentConductaProSociale5M3Binding? = null
    ...
    private val resolver by lazy {
        ConductaProSocialFragmentE5M3Resolver()
    }
    ...
    override fun onCreateView(
        ...
        binding = FragmentConductaProSociale5M3Binding.inflate(inflater, container, false)
    ...
    private fun initResources(binding: FragmentConductaProSociale5M3Binding) {
        ...
        with(binding, {
            ...
            this@ConductaProSocialFragmentE5M3.etAprobadasT1 = etAprobadasT1

            //TOTAL
            this@ConductaProSocialFragmentE5M3.tvPdTotal = tvPdTotalValue
