...
import cl.figonzal.evaluatool.resolvers.evalua5.modulo3.ConductaProSocialFragmentE5M3Resolver.Companion.DEVIATION
import cl.figonzal.evaluatool.resolvers.evalua5.modulo3.ConductaProSocialFragmentE5M3Resolver.Companion.MEAN
...
class ConductaProSocialFragmentE5M3 : Fragment() {
    ...
    private fun initResources(binding: FragmentConductaProSociale5M3Binding) {
        ...
        with(binding) {
            ...
            this@ConductaProSocialFragmentE5M3.etApprovedT1 = etAprobadasT1
