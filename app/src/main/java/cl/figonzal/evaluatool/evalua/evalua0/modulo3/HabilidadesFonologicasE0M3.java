...
public class HabilidadesFonologicasE0M3 extends AppCompatActivity implements EvaluaInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_habilidades_fonologicas_e0_m3);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        if (item.getItemId() == android.R.id.home) {
            ...
            crashlytics.log(getString(R.string.TAG_HABILIDADES_FONOLOGICAS) + getString(R.string.ACTIVIDAD_CERRADA));
