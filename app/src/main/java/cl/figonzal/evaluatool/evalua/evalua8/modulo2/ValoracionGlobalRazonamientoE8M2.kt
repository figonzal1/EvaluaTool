...
import cl.figonzal.evaluatool.databinding.ActivityValoracionGlobalRazonamientoE8M2Binding
...
class ValoracionGlobalRazonamientoE8M2 : AppCompatActivity(), IndiceValorInterface {

    private lateinit var binding: ActivityValoracionGlobalRazonamientoE8M2Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityValoracionGlobalRazonamientoE8M2Binding.inflate(layoutInflater)
    ...
    private fun initResources() {
        ...
        with(binding, {
            this@ValoracionGlobalRazonamientoE8M2.etTotalesT1 = etTotalesT1
            this@ValoracionGlobalRazonamientoE8M2.etTotalesT2 = etTotalesT2
            this@ValoracionGlobalRazonamientoE8M2.etTotalesT3 = etTotalesT3
            ...
            //TOTAL
            this@ValoracionGlobalRazonamientoE8M2.tvPdTotal = tvPdTotalValue
        }).also {
            textWatcherTarea1()
        }
    }
        ...
        with(etTotalesT1) {
            addTextChangedListener(object : TextWatcher {
                ...
                override fun afterTextChanged(s: Editable) {
                    ...
                    tvSubTotalT1.text =
                        String.format(getString(R.string.POINTS_FORMAT), "RI: ", subTotalT1)
                    calculateResult()
                }
            })
        }
        with(etTotalesT2) {
            addTextChangedListener(object : TextWatcher {
                ...
                override fun afterTextChanged(s: Editable) {
                    ...
                    tvSubTotalT2.text =
                        String.format(getString(R.string.POINTS_FORMAT), "RE: ", subTotalT2)
                    calculateResult()
                }
            })
        }
        with(etTotalesT3) {
            addTextChangedListener(object : TextWatcher {
                ...
                override fun afterTextChanged(s: Editable) {
                    ...
                    tvSubTotalT3.text =
                        String.format(getString(R.string.POINTS_FORMAT), "RD: ", subTotalT3)
                    calculateResult()
                }
            })
        }
