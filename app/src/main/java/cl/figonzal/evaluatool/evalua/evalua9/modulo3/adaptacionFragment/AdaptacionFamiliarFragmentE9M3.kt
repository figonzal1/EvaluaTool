...
import cl.figonzal.evaluatool.baremosTables.adaptacionFamiliarE9M3Baremo
import cl.figonzal.evaluatool.databinding.FragmentAdaptacionFamiliarE9M3Binding
...
class AdaptacionFamiliarFragmentE9M3 : Fragment(), EvaluaInterface {

    companion object {

        private const val MEDIA = 19.14

        fun newInstance(): AdaptacionFamiliarFragmentE9M3 {
            return AdaptacionFamiliarFragmentE9M3()
        }
    }

    private var binding: FragmentAdaptacionFamiliarE9M3Binding? = null
    private val perc = adaptacionFamiliarE9M3Baremo()
    ...
    override fun onCreateView(
        ...
        binding = FragmentAdaptacionFamiliarE9M3Binding.inflate(inflater, container, false)

        initResources(binding!!)
        return binding!!.root
    }

    private fun initResources(binding: FragmentAdaptacionFamiliarE9M3Binding) {
        ...
        with(binding, {
            ...
            this@AdaptacionFamiliarFragmentE9M3.etAprobadasT1 = etAprobadasT1

            //TOTAL
            this@AdaptacionFamiliarFragmentE9M3.tvPdTotal = tvPdTotalValue
            tvPdCorregido = tvPdTotalCorregidoValue
            this@AdaptacionFamiliarFragmentE9M3.tvPercentil = tvPercentilValue
