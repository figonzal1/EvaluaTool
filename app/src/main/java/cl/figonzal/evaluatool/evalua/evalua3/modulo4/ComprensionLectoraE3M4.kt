...
class ComprensionLectoraE3M4 : AppCompatActivity(), EvaluaInterface {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_comprension_lectora_e3_m4)
    ...
    private fun instanciarRecursosInterfaz() {
        ...
        Utilidades.configurarTextoBaremo(supportFragmentManager, tvBaremo, perc, getString(R.string.TOOLBAR_COMPREN_LECTORA))
