...
public class VelocidadLectoraE5M4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewPager2.setAdapter(new FragmentStateAdapterE5M4(this));

        //TabLayout
        TabLayout tabLayout = findViewById(R.id.tabs_velocidad);
        new TabLayoutMediator(tabLayout, viewPager2, (tab, position) -> tab.setText(FragmentStateAdapterE5M4.getTabs()[position])).attach();
    }
