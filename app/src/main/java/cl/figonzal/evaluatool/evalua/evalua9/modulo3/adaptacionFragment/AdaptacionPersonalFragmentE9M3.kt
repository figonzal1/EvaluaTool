...
import cl.figonzal.evaluatool.resolvers.evalua9.modulo3.AdaptacionPersonalFragmentE9M3Resolver.Companion.MEAN
...
class AdaptacionPersonalFragmentE9M3 : Fragment() {
    ...
    private fun initResources(binding: FragmentAdaptacionPersonalE9M3Binding) {
        ...
        with(binding) {
            ...
            this@AdaptacionPersonalFragmentE9M3.etApprovedT1 = etAprobadasT1

            //TOTAL
            this@AdaptacionPersonalFragmentE9M3.tvPdTotal = tvPdTotalValue
            tvPdCorrected = tvPdTotalCorregidoValue
            this@AdaptacionPersonalFragmentE9M3.tvPercentile = tvPercentilValue
