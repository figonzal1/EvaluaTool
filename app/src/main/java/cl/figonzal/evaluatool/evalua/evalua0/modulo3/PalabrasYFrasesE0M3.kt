...
class PalabrasYFrasesE0M3 : AppCompatActivity(), EvaluaInterface {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        actionBar.title = getString(R.string.TOOLBAR_PALABRAS_FRASES)
    ...
    private fun instanciarRecursosInterfaz() {
        ...
        EvaluaUtils.configurarTextoBaremo(supportFragmentManager, tvBaremo, perc, getString(R.string.TOOLBAR_PALABRAS_FRASES))
