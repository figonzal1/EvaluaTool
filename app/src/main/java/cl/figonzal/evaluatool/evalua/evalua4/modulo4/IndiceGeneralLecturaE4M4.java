...
public class IndiceGeneralLecturaE4M4 extends AppCompatActivity implements IndiceValorInterface {
    //TAREA 1
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_indice_general_lectura_e4_m4);
        ...
        actionBar.setTitle(R.string.TOOLBAR_INDICE_GENERAL_LECTURA);
    ...
    private void textWatcherTarea1() {
        ...
        et_totales_t2.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                tv_sub_total_t2.setText(String.format(Locale.US, "%s: %s pts", "VL", sub_total_t2));
                calcularResultado();
            }
        });
