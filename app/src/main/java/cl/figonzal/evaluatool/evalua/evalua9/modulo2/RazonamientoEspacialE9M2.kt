...
class RazonamientoEspacialE9M2 : AppCompatActivity(), EvaluaInterface {
            ...
            addTextChangedListener(object : TextWatcher {
                ...
                override fun afterTextChanged(s: Editable) {
                    ...
                    subTotalPdT1 = calculateTask(
                        1,
                        tvSubTotalT1,
                        context.getString(R.string.TAREA_1_1),
                        aprobadasT1,
                        0,
                        reprobadasT1
                    )
            ...
            addTextChangedListener(object : TextWatcher {
                ...
                override fun afterTextChanged(s: Editable) {
                    ...
                    subTotalPdT2 = calculateTask(
                        2,
                        tvSubTotalT2,
                        context.getString(R.string.TAREA_1_2),
                        aprobadasT2,
                        0,
                        reprobadasT2
                    )
