...
import cl.figonzal.evaluatool.databinding.FragmentAutoControlE7M3Binding
import cl.figonzal.evaluatool.resolvers.evalua7.modulo3.AutoControlFragmentE7M3Resolver
import cl.figonzal.evaluatool.resolvers.evalua7.modulo3.AutoControlFragmentE7M3Resolver.Companion.DESVIACION
import cl.figonzal.evaluatool.resolvers.evalua7.modulo3.AutoControlFragmentE7M3Resolver.Companion.MEDIA
...
class AutoControlFragmentE7M3 : Fragment() {
    ...
    companion object {
        fun newInstance(): AutoControlFragmentE7M3 {
            return AutoControlFragmentE7M3()
        }
    }

    private var binding: FragmentAutoControlE7M3Binding? = null
    ...
    private val resolver by lazy {
        AutoControlFragmentE7M3Resolver()
    }
    ...
    override fun onCreateView(
        ...
        binding = FragmentAutoControlE7M3Binding.inflate(inflater, container, false)

        initResources(binding!!)
        return binding!!.root
    }

    private fun initResources(binding: FragmentAutoControlE7M3Binding) {
        ...
        with(binding, {
            ...
            this@AutoControlFragmentE7M3.etAprobadasT1 = etAprobadasT1

            //TOTAL
            this@AutoControlFragmentE7M3.tvPdTotal = tvPdTotalValue
