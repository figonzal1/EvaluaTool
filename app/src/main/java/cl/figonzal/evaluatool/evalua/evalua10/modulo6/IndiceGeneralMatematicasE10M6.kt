...
import cl.figonzal.evaluatool.databinding.ActivityIndiceGeneralMatematicasE10M6Binding
...
class IndiceGeneralMatematicasE10M6 : AppCompatActivity(), IndiceValorInterface {
    private lateinit var binding: ActivityIndiceGeneralMatematicasE10M6Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        configActionBar(R.string.TOOLBAR_INDICE_GENERAL_MATEMATICO, binding.include.toolbar)
    ...
    private fun initResources() {
        ...
        with(binding, {
            this@IndiceGeneralMatematicasE10M6.etTotalesT1 = etTotalesT1
            this@IndiceGeneralMatematicasE10M6.etTotalesT2 = etTotalesT2

            //SUBTOTAL
            tvSubTotalT1 = tvPdSubtotalT1
            tvSubTotalT2 = tvPdSubtotalT2
            //TOTAL
            this@IndiceGeneralMatematicasE10M6.tvPdTotal = tvPdTotalValue
        }).also {
            textWatcherTarea1()
        }
    }
