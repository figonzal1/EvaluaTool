...
class AdaptacionPersonalFragmentE8M3 : Fragment(), EvaluaInterface {
    ...
    private val perc = adaptacionPersonalFragmentE8M3Baremo()
    ...
    override fun calculatePercentile(pdTotal: Int): Int {
        when {
            pdTotal < perc.first()[0] as Int -> return perc.first()[1]
            pdTotal > perc.last()[0] as Int -> return perc.last()[1]
            else -> perc.forEach { item ->
                if (pdTotal == item.first()) return item[1]
            }
        }
