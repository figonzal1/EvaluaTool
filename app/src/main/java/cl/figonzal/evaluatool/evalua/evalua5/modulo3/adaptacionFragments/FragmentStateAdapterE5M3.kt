...
class FragmentStateAdapterE5M3(fa: FragmentActivity) : FragmentStateAdapter(fa) {
    ...
    override fun createFragment(position: Int): Fragment {
        return when (position) {
            0 -> MotivacionFragmentE5M3.newInstance()
            1 -> AutoControlFragmentE5M3.newInstance()
            2 -> ConductaProSocialFragmentE5M3.newInstance()
            3 -> AutoEstimaFragmentE5M3.newInstance()
            else -> AutoEstimaFragmentE5M3.newInstance()
        }
    }
