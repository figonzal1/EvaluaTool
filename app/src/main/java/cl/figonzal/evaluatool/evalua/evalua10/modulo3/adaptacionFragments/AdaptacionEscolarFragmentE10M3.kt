...
class AdaptacionEscolarFragmentE10M3 : Fragment(), EvaluaInterface {
    ...
    private val perc = adaptacionEscolarE10M3Baremo()
    ...
    override fun calculateResult() {
        ...
        with(subtotalPdT1, {
            ...
            tvDesviacionCalculada.text =
                Utils.calcularDesviacion(
                    MEDIA,
                    DESVIACION, pdCorregido, true
                ).toString()
