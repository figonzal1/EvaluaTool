...
public class ValoracionGlobalAprenMatematE3M6 extends AppCompatActivity implements IndiceValorInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_valoracion_global_apren_matemat_e3_m6);
