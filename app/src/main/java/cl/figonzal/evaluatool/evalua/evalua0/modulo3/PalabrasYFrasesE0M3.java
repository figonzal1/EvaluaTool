...
public class PalabrasYFrasesE0M3 extends AppCompatActivity implements EvaluaInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_palabras_y_frases_e0_m3);
        ...
        actionBar.setTitle(getString(R.string.TOOLBAR_PALABRAS_FRASES));
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        if (item.getItemId() == android.R.id.home) {
            ...
            Log.d(getString(R.string.TAG_PALABRAS_FRASES), getString(R.string.ACTIVIDAD_CERRADA));

            crashlytics.log(getString(R.string.TAG_PALABRAS_FRASES) + getString(R.string.ACTIVIDAD_CERRADA));
