...
import cl.figonzal.evaluatool.baremosTables.eficaciaLectoraE9M4Baremo
...
class EficaciaLectoraE9M4 : AppCompatActivity(), EvaluaInterface {
    companion object {
        private const val DESVIACION = 3.99
        private const val MEDIA = 5.73
    }

    private lateinit var binding: ActivityEficaciaLectoraE9M4Binding

    //PD, PC CHILE
    private val perc = eficaciaLectoraE9M4Baremo()
