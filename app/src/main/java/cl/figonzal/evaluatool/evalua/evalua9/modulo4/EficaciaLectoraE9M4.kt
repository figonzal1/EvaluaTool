...
import cl.figonzal.evaluatool.databinding.ActivityEficaciaLectoraE9M4Binding
import cl.figonzal.evaluatool.resolvers.evalua9.modulo4.EficaciaLectoraE9M4Resolver
import cl.figonzal.evaluatool.resolvers.evalua9.modulo4.EficaciaLectoraE9M4Resolver.Companion.DESVIACION
import cl.figonzal.evaluatool.resolvers.evalua9.modulo4.EficaciaLectoraE9M4Resolver.Companion.MEDIA
...
class EficaciaLectoraE9M4 : AppCompatActivity() {

    private lateinit var binding: ActivityEficaciaLectoraE9M4Binding
    ...
    private val resolver by lazy {
        EficaciaLectoraE9M4Resolver()
    }

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityEficaciaLectoraE9M4Binding.inflate(layoutInflater)
        setContentView(binding.root)

        configureActionBar(
            R.string.TOOLBAR_EFICACIA_LECTORA,
    ...
    private fun initResources() {
        ...
        with(binding, {
            ...
            this@EficaciaLectoraE9M4.etAprobadasT1 = etAprobadasT1

            //TOTALES
            this@EficaciaLectoraE9M4.tvPdTotal = tvPdTotalValue
