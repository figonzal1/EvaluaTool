...
import cl.figonzal.evaluatool.databinding.FragmentConductaProSocialE4M3Binding
import cl.figonzal.evaluatool.resolvers.evalua4.modulo3.ConductaProSocialFragmentE4M3Resolver
import cl.figonzal.evaluatool.resolvers.evalua4.modulo3.ConductaProSocialFragmentE4M3Resolver.Companion.DEVIATION
import cl.figonzal.evaluatool.resolvers.evalua4.modulo3.ConductaProSocialFragmentE4M3Resolver.Companion.MEDIA
...
class ConductaProSocialFragmentE4M3 : Fragment() {

    companion object {

        @JvmStatic
        fun newInstance(): ConductaProSocialFragmentE4M3 {
            return ConductaProSocialFragmentE4M3()
        }
    }
    ...
    private val resolver by lazy {
        ConductaProSocialFragmentE4M3Resolver()
    }
    ...
    private fun initResources(binding: FragmentConductaProSocialE4M3Binding) {
        ...
        with(binding) {
            ...
            this@ConductaProSocialFragmentE4M3.etApprovedT1 = etAprobadasT1

            //TOTAL
            this@ConductaProSocialFragmentE4M3.tvPdTotal = tvPdTotalValue
    ...
    private fun calculateResult() {
        ...
        resolver.run {
            ...
            tvCalculatedDeviation.text =
                EvaluaUtils.calcularDesviacion2(MEDIA, DEVIATION, pdCorrected, reverse = true)
