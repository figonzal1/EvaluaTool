...
import cl.figonzal.evaluatool.resolvers.evalua4.modulo3.ConductaProSocialFragmentE4M3Resolver.Companion.DESVIACION
...
class ConductaProSocialFragmentE4M3 : Fragment() {
    ...
    private fun initResources(binding: FragmentConductaProSocialE4M3Binding) {
        ...
        with(binding, {
            ...
            this@ConductaProSocialFragmentE4M3.etAprobadasT1 = etAprobadasT1
