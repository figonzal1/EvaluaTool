...
import cl.figonzal.evaluatool.domain.baremos.ortografiaFoneticaE5M5Baremo
import cl.figonzal.evaluatool.domain.resolvers.BaseResolver
import kotlin.math.floor

class OrtografiaFoneticaE5M5Resolver : BaseResolver {

    var totalPdTask1 = 0.0
    var totalPdTask2 = 0.0

    override val perc = ortografiaFoneticaE5M5Baremo()
    ...
    companion object {
        const val DEVIATION = 7.65
        const val MEAN = 41.03
    }
}