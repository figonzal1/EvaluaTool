...
class RazonamientoEspacialE7M2Resolver(
    baremoTable: BaremoTable
) : BaseResolver {

    var totalPdTask1 = 0.0
    var totalPdTask2 = 0.0
    override val percentile = baremoTable.getBaremo(Evalua7Constants.RAZONAMIENTO_ESPACIAL_E7M2)
