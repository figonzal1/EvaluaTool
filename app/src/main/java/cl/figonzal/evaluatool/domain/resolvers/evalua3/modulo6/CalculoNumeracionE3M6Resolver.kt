...
class CalculoNumeracionE3M6Resolver(
    ...
    override val percentile = baremoTable.getBaremo(Evalua3Constants.CALCULO_NUMERACION_E3M6)
    ...
    companion object {
        const val DEVIATION = 6.50
        const val MEAN = 19.56
    }
}