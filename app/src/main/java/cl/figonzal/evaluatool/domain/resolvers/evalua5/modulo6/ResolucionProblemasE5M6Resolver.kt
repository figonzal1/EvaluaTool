...
import cl.figonzal.evaluatool.domain.baremos.resolucionProblemasE5M6Baremo
import cl.figonzal.evaluatool.domain.resolvers.BaseResolver
import kotlin.math.floor

class ResolucionProblemasE5M6Resolver : BaseResolver {

    var totalPdTask1 = 0.0
    var totalPdTask2 = 0.0

    override val perc = resolucionProblemasE5M6Baremo()
    ...
    companion object {
        const val DEVIATION = 10.75
        const val MEAN = 17.87
    }
}