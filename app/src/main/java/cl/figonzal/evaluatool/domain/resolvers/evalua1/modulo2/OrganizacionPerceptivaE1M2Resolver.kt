...
import cl.figonzal.evaluatool.domain.baremos.organizacionPerceptivaE1M2Baremo
...
class OrganizacionPerceptivaE1M2Resolver : BaseResolver {
    ...
    override val perc = organizacionPerceptivaE1M2Baremo()
    ...
    companion object {
        const val DEVIATION = 11.36
        const val MEAN = 38.01
    }
}