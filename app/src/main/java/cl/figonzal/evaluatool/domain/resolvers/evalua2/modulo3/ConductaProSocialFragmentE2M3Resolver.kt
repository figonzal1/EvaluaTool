...
import cl.figonzal.evaluatool.domain.baremos.conductaProSocialFragmentE2M3Baremo
import cl.figonzal.evaluatool.domain.resolvers.BaseResolver
import kotlin.math.floor

class ConductaProSocialFragmentE2M3Resolver : BaseResolver {
    var totalPdTask1 = 0.0

    override val perc = conductaProSocialFragmentE2M3Baremo()
    ...
    companion object {
        const val DEVIATION = 3.69
        const val MEAN = 26.12
    }
}