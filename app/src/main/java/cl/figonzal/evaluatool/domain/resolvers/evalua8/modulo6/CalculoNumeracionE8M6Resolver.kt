...
class CalculoNumeracionE8M6Resolver(
    baremoTable: BaremoTable
) : BaseResolver {

    var totalPdTask1 = 0.0
    override val percentile = baremoTable.getBaremo(Evalua8Constants.CALCULO_NUMERACION_E8M6)
    ...
    companion object {
        const val DEVIATION = 6.92
        const val MEAN = 15.30
    }
}