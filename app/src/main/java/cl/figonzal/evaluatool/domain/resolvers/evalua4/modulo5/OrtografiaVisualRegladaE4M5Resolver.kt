...
import cl.figonzal.evaluatool.domain.baremos.ortografiaVisualRegladaE4M5Baremo
import cl.figonzal.evaluatool.domain.resolvers.BaseResolver
import kotlin.math.floor

class OrtografiaVisualRegladaE4M5Resolver : BaseResolver {

    var totalPdTask1 = 0.0
    var totalPdTask2 = 0.0

    override val perc = ortografiaVisualRegladaE4M5Baremo()
    ...
    companion object {
        const val DEVIATION = 16.04
        const val MEAN = 40.62
    }
}