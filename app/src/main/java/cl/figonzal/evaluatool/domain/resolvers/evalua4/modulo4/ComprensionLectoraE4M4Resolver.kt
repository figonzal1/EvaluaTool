...
import cl.figonzal.evaluatool.domain.baremo_tables.comprensionLectoraE4M4Baremo
...
class ComprensionLectoraE4M4Resolver : BaseResolver {
    ...
    override val percentile = comprensionLectoraE4M4Baremo()
    ...
    companion object {
        const val DEVIATION = 6.63
        const val MEAN = 21.47
    }
}