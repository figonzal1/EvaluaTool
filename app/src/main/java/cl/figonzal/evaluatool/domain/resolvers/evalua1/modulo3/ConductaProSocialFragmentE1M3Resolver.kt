...
import cl.figonzal.evaluatool.domain.baremos.conductaProSocialFragmentE1M3Baremo
...
class ConductaProSocialFragmentE1M3Resolver : BaseResolver {
    ...
    override val perc = conductaProSocialFragmentE1M3Baremo()
    ...
    companion object {
        const val DEVIATION = 5.24
        const val MEAN = 24.79
    }
}