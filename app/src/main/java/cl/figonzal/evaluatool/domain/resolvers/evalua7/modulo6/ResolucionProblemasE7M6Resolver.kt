...
import cl.figonzal.evaluatool.domain.baremo_tables.resolucionProblemasE7M6Baremo
...
class ResolucionProblemasE7M6Resolver : BaseResolver {
    ...
    override val percentile = resolucionProblemasE7M6Baremo()
    ...
    companion object {
        const val DEVIATION = 8.62
        const val MEAN = 10.51
    }
}