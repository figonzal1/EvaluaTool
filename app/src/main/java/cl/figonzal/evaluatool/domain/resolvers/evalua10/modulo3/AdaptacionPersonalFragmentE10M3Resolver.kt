...
import cl.figonzal.evaluatool.domain.baremo_tables.adaptacionPersonalFragmentE10M3Baremo
import cl.figonzal.evaluatool.domain.resolvers.BaseResolver

class AdaptacionPersonalFragmentE10M3Resolver : BaseResolver {

    var totalPdTask1 = 0.0
    override val percentile = adaptacionPersonalFragmentE10M3Baremo()
    ...
    companion object {
        const val MEAN = 20.27
        const val DEVIATION = 12.29
    }
}