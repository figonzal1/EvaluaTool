...
import cl.figonzal.evaluatool.domain.baremos.adaptacionEscolarFragmentE10M3Baremo
import cl.figonzal.evaluatool.domain.resolvers.BaseResolver

class AdaptacionEscolarFragmentE10M3Resolver : BaseResolver {

    var totalPdTask1 = 0.0
    override val perc = adaptacionEscolarFragmentE10M3Baremo()
    ...
    companion object {
        const val MEAN = 20.72
        const val DEVIATION = 10.24
    }
}