...
import cl.figonzal.evaluatool.domain.baremos.motivacionFragmentE2M3Baremo
import cl.figonzal.evaluatool.domain.resolvers.BaseResolver
import kotlin.math.floor

class MotivacionFragmentE2M3Resolver : BaseResolver {

    var totalPdTask1 = 0.0

    override val perc = motivacionFragmentE2M3Baremo()
    ...
    companion object {
        const val DEVIATION = 4.44
        const val MEAN = 34.65
    }
}