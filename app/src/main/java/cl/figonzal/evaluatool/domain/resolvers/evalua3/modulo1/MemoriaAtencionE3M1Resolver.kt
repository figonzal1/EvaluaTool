...
package cl.figonzal.evaluatool.domain.resolvers.evalua3.modulo1

import cl.figonzal.evaluatool.domain.baremos.memoriaAtencionE3M1Baremo
import cl.figonzal.evaluatool.domain.resolvers.BaseResolver
import kotlin.math.floor

class MemoriaAtencionE3M1Resolver : BaseResolver {
    ...
    override val perc = memoriaAtencionE3M1Baremo()
    ...
    companion object {
        const val DEVIATION = 18.78
        const val MEAN = 84.36
    }
}