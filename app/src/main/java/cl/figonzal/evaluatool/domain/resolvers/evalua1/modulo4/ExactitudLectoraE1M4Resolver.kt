...
import cl.figonzal.evaluatool.domain.baremos.exactitudLectoraE1M4Baremo
import cl.figonzal.evaluatool.domain.resolvers.BaseResolver
import kotlin.math.floor

class ExactitudLectoraE1M4Resolver : BaseResolver {
    ...
    override val perc = exactitudLectoraE1M4Baremo()
    ...
    companion object {
        const val DEVIATION = 25.02
        const val MEAN = 98.38
    }
}