...
class OrganizacionPerceptivaE2M1Resolver(
    ...
    override val percentile = baremoTable.getBaremo(Evalua2Constants.ORGANIZACION_PERCEPTIVA_E2M1)
    ...
    companion object {
        const val DEVIATION = 8.17
        const val MEAN = 26.64
    }
}