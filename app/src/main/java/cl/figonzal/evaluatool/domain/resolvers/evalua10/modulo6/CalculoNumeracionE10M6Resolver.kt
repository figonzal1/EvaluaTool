...
class CalculoNumeracionE10M6Resolver(
    baremoTable: BaremoTable
) : BaseResolver {

    var totalPdTask1 = 0.0
    override val percentile = baremoTable.getBaremo(Evalua10Constants.CALCULO_NUMERACION_E10M6)
    ...
    companion object {
        const val DEVIATION = 6.01
        const val MEAN = 15.52
    }
}