...
import cl.figonzal.evaluatool.domain.baremo_tables.autoEstimaFragmentE1M3Baremo
...
class AutoEstimaFragmentE1M3Resolver : BaseResolver {
    ...
    override val percentile = autoEstimaFragmentE1M3Baremo()
    ...
    companion object {
        const val DEVIATION = 4.93
        const val MEAN = 21.78
    }
}