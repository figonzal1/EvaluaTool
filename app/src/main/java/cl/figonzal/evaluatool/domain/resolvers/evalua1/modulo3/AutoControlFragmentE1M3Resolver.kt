...
import cl.figonzal.evaluatool.domain.baremos.autoControlFragmentE1M3Baremo
import cl.figonzal.evaluatool.domain.resolvers.BaseResolver
import kotlin.math.floor

class AutoControlFragmentE1M3Resolver : BaseResolver {

    var totalPdTask1 = 0.0

    override val perc = autoControlFragmentE1M3Baremo()
    ...
    companion object {
        const val DEVIATION = 5.06
        const val MEAN = 22.24
    }
}