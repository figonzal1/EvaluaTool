...
package cl.figonzal.evaluatool.domain.resolvers.evalua10.modulo5

import cl.figonzal.evaluatool.domain.baremos.ortografiaVisualRegladaE10M5Baremo
import cl.figonzal.evaluatool.domain.resolvers.BaseResolver
import kotlin.math.floor

class OrtografiaVisualRegladaE10M5Resolver : BaseResolver {

    var totalPdTask1 = 0.0
    var totalPdTask2 = 0.0
    override val perc = ortografiaVisualRegladaE10M5Baremo()
    ...
    companion object {
        const val DEVIATION = 14.25
        const val MEAN = 47.84
    }
}