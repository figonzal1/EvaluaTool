...
class ComprensionLectoraE7M4Resolver(
    ...
    override val percentile = baremoTable.getBaremo(Evalua7Constants.COMPRENSION_LECTORA_E7M4)
    ...
    override fun calculateTask(
        ...
        var total = floor(
            when (nTask) {
                1, 3 -> approved - reprobate / 4.0
                2 -> approved - reprobate / 2.0
                4 -> approved - reprobate / 3.0
                else -> 0.0
            }
        )
    ...
    companion object {
        const val DEVIATION = 6.71
        const val MEAN = 14.52
    }
}