...
import cl.figonzal.evaluatool.domain.baremos.reflexividadE4M2Baremo
...
class ReflexividadE4M2Resolver : BaseResolver {
    ...
    override val perc = reflexividadE4M2Baremo()
    ...
    companion object {
        const val DEVIATION = 5.33
        const val MEAN = 13.94
    }
}