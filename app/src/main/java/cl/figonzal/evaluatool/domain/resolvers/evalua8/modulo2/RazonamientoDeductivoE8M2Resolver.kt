...
class RazonamientoDeductivoE8M2Resolver(
    baremoTable: BaremoTable
) : BaseResolver {

    var totalPdTask1 = 0.0
    override val percentile = baremoTable.getBaremo(Evalua8Constants.RAZONAMIENTO_DEDUCTIVO_E8M2)
