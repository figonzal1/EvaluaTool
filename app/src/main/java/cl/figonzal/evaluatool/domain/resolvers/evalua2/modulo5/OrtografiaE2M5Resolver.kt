...
import cl.figonzal.evaluatool.domain.baremo_tables.ortografiaVisualRegladaE5M5Baremo
...
class OrtografiaE2M5Resolver : BaseResolver {
    ...
    companion object {
        const val DEVIATION = 9.463
        const val MEAN = 31.42
    }
}