...
public class ValoracionGlobalLecturaE5M4 extends AppCompatActivity implements ValoracionInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_valoracion_global_lectura_e5_m4);
    ...
    private void textWatcherTarea1() {
        ...
        et_totales_t1.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                tv_sub_total_t1.setText(String.format(Locale.US, "%s: %s pts", "CL", sub_total_t1));
                calcularResultado();
            }
        });
        ...
        et_totales_t2.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                tv_sub_total_t2.setText(String.format(Locale.US, "%s: %s pts", "EL", sub_total_t2));
                calcularResultado();
            }
        });
        ...
        et_totales_t3.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                tv_sub_total_t3.setText(String.format(Locale.US, "%s: %s pts", "VL", sub_total_t3));
                calcularResultado();
            }
        });
    }
