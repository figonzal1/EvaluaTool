...
public class CalculoNumeracionE5M6 extends AppCompatActivity implements EvaluaInterface {

    private static final double DESVIACION = 10.85;
    private static final double MEDIA = 30.16;
    ...
    private void textWatcherTarea4() {
        et_aprobadas_t4.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                subtotal_pd_t4 = calcularTarea(4, tv_sub_total_t4, "Tarea 4: ", aprobadas_t4, null, null);
                calcularResultado();
            }
        });
