...
public class OrtografiaFoneticaE5M5 extends AppCompatActivity implements EvaluaInterface {

    private static final double DESVIACION = 7.65;
    private static final double MEDIA = 41.03;
    //PD,PC CHILE
