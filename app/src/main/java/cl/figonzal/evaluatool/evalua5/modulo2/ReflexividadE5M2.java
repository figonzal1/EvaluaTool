...
public class ReflexividadE5M2 extends AppCompatActivity implements EvaluaInterface {

    private static final double DESVIACION = 4.59;
    private static final double MEDIA = 7.92;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reflexividad_e5_m2);
