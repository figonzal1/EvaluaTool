...
public class ComprensionLectoraE5M4 extends AppCompatActivity implements EvaluaInterface {

    private static final double DESVIACION = 7.14;
    private static final double MEDIA = 18.65;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_comprension_lectora_e5_m4);
