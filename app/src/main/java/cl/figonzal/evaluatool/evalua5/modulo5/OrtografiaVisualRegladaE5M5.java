/*-----------------------------------------------------------------------------
 ...
 Copyright (c) 2020                                                           -
                                                                              -
 Last modified 29-07-20 22:19                                                 -
 -----------------------------------------------------------------------------*/

package cl.figonzal.evaluatool.evalua5.modulo5;
...
public class OrtografiaVisualRegladaE5M5 extends AppCompatActivity implements EvaluaInterface {

    private static final double DESVIACION = 13.45;
    private static final double MEDIA = 34.57;
