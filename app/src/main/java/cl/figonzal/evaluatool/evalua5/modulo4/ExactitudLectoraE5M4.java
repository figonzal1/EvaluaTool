...
public class ExactitudLectoraE5M4 extends AppCompatActivity implements EvaluaInterface {

    private static final double DESVIACION = 9.10;
    private static final double MEDIA = 33.54;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_exactitud_lectora_e5_m4);
    ...
    private void textWatcherTarea2() {
        ...
        et_omitidas_t2.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                subtotal_pd_t1 = calcularTarea(2, tv_sub_total_t2, "Tarea 2: ", aprobadas_t2, omitidas_t2, reprobadas_t2);
                calcularResultado();
