/*-----------------------------------------------------------------------------
 ...
 Copyright (c) 2020                                                           -
                                                                              -
 Last modified 30-07-20 17:34                                                 -
 -----------------------------------------------------------------------------*/

package cl.figonzal.evaluatool.evalua5.modulo6;
...
public class ResolucionProblemasE5M6 extends AppCompatActivity implements EvaluaInterface {

    private static final double DESVIACION = 10.75;
    private static final double MEDIA = 17.87;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_resolucion_problemas_e5_m6);
    ...
    private void textWatcherTarea1() {
        et_aprobadas_t1.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                total_pd_t1 = calcularTarea(1, tv_sub_total_t1, "Tareas 1: ", aprobadas_t1, null, null);
                calcularResultado();
            }
        });
    }
    ...
    private void textWatcherTarea2() {
        et_aprobadas_t2.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                total_pd_t2 = calcularTarea(2, tv_sub_total_t2, "Tareas 2: ", aprobadas_t2, null, null);
                calcularResultado();
            }
        });
    }
