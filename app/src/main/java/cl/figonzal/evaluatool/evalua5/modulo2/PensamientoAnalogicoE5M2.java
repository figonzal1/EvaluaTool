/*-----------------------------------------------------------------------------
 ...
 Copyright (c) 2020                                                           -
                                                                              -
 Last modified 27-07-20 2:05                                                  -
 -----------------------------------------------------------------------------*/

package cl.figonzal.evaluatool.evalua5.modulo2;
...
public class PensamientoAnalogicoE5M2 extends AppCompatActivity implements EvaluaInterface {

    private static final double DESVIACION = 4.55;
    private static final double MEDIA = 9.46;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pensamiento_analogico_e5_m2);
