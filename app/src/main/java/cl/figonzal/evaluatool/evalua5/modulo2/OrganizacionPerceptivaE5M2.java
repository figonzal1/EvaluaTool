...
public class OrganizacionPerceptivaE5M2 extends AppCompatActivity implements EvaluaInterface {

    private static final double DESVIACION = 4.01;
    private static final double MEDIA = 8.07;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_organizacion_perceptiva_e5_m2);
