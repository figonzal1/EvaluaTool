/*-----------------------------------------------------------------------------
 ...
 Copyright (c) 2020                                                           -
                                                                              -
 Last modified 02-07-20 18:29                                                 -
 -----------------------------------------------------------------------------*/

package cl.figonzal.evaluatool.evalua1.modulo3;
...
import cl.figonzal.evaluatool.evalua1.modulo3.adaptacionFragments.FragmentPageAdapterE1M3;

public class NivelesAdaptacionE1M3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_niveles_adaptacion_e1_m3);
        ...
        viewPager.setAdapter(new FragmentPageAdapterE1M3(getSupportFragmentManager()));
