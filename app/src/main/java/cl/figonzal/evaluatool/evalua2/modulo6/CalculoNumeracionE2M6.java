/*-----------------------------------------------------------------------------
 ...
 Copyright (c) 2020                                                           -
                                                                              -
 Last modified 05-07-20 16:35                                                 -
 -----------------------------------------------------------------------------*/

package cl.figonzal.evaluatool.evalua2.modulo6;
...
public class CalculoNumeracionE2M6 extends AppCompatActivity implements EvaluaInterface {
    ...
    private void textWatcherTarea2() {
        ...
        et_aprobadas_t2.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                subtotal_pd_t2 = calcularTarea(1, tv_sub_total_t2, "Tarea 1: ", aprobadas_t2, null, reprobadas_t2);
                calcularResultado();
            }
        });
        ...
        if (pd_total < 0) {
            ...
            for (Integer[] item : perc) {
                if (pd_total == item[0]) {
                    ...
                    return item[0];
                } else if (pd_total - 9 == item[0]) {
                    return item[0];
                } else if (pd_total - 10 == item[0]) {
                    return item[0];
                }
            }
        }
