...
public class MemoriaAtencion extends AppCompatActivity implements EvaluaInterface {
    ...
    private TextView tv_sub_total_t6;
    ...
    private double subtotal_pd_t6 = 0;
    ...
    private void instanciarRecursosInterfaz() {
        ...
        et_omitidas_t5 = findViewById(R.id.et_omitidas_t5);
        ...
        et_omitidas_t6 = findViewById(R.id.et_omitidas_t6);
    ...
    private void textWatcherTarea5() {
        et_aprobadas_t5.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                subtotal_pd_t5 = calcularTarea(null, tv_sub_total_t5, "Tarea 5: ", aprobadas_t5, omitidas_t5, reprobadas_t5);
                calcularResultado();
            }
        });

        et_omitidas_t5.addTextChangedListener(new TextWatcher() {
            @Override
            public void beforeTextChanged(CharSequence s, int start, int count, int after) {
                subtotal_pd_t5 = 0;
            }
            ...
            public void afterTextChanged(Editable s) {
                ...
                if (s.length() == 0) {
                    ...
                    omitidas_t5 = Integer.parseInt(Objects.requireNonNull(et_omitidas_t5.getText()).toString());
                }
                subtotal_pd_t5 = calcularTarea(null, tv_sub_total_t5, "Tarea 5: ", aprobadas_t5, omitidas_t5, reprobadas_t5);
                calcularResultado();
            }
    ...
    private void textWatcherTarea6() {
        et_aprobadas_t6.addTextChangedListener(new TextWatcher() {
            @Override
            public void beforeTextChanged(CharSequence s, int start, int count, int after) {
                subtotal_pd_t6 = 0;
            }
            ...
            public void afterTextChanged(Editable s) {
                ...
                subtotal_pd_t6 = calcularTarea(null, tv_sub_total_t6, "Tarea 6: ", aprobadas_t6, omitidas_t6, reprobadas_t6);
                calcularResultado();
            }
        });

        et_omitidas_t6.addTextChangedListener(new TextWatcher() {
            @Override
            public void beforeTextChanged(CharSequence s, int start, int count, int after) {
                subtotal_pd_t6 = 0;
            }
            ...
            public void afterTextChanged(Editable s) {
                ...
                if (s.length() == 0) {
                    ...
                    omitidas_t6 = Integer.parseInt(Objects.requireNonNull(et_omitidas_t6.getText()).toString());
                }
                subtotal_pd_t6 = calcularTarea(null, tv_sub_total_t6, "Tarea 6: ", aprobadas_t6, omitidas_t6, reprobadas_t6);
                calcularResultado();
            }
    ...
    public void calcularResultado() {
        ...
        //TOTALES
        double total_pd;
        total_pd = subtotal_pd_t1 + subtotal_pd_t2 + subtotal_pd_t3 + subtotal_pd_t4 + subtotal_pd_t5 + subtotal_pd_t6;
