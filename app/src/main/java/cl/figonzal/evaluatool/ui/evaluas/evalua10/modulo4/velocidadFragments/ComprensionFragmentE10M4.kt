...
import cl.figonzal.evaluatool.domain.resolvers.evalua10.modulo4.ComprensionFragmentE10M4Resolver.Companion.DEVIATION
import cl.figonzal.evaluatool.domain.resolvers.evalua10.modulo4.ComprensionFragmentE10M4Resolver.Companion.MEAN
...
class ComprensionFragmentE10M4 : Fragment() {
    ...
    private var _binding: FragmentComprensionE10M4Binding? = null
    ...
    private val resolver: ComprensionFragmentE10M4Resolver by inject()

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View {
        _binding = FragmentComprensionE10M4Binding.inflate(inflater, container, false)
    ...
    private fun initResources(binding: FragmentComprensionE10M4Binding) {
        ...
        with(binding) {
            ...
            this@ComprensionFragmentE10M4.etApprovedT1 = etAprobadasT1
            this@ComprensionFragmentE10M4.etOmittedT1 = etOmitidasT1
            this@ComprensionFragmentE10M4.etReprobateT1 = etReprobadasT1

            //TOTAL
            this@ComprensionFragmentE10M4.tvPdTotal = tvPdTotalValue
            tvPdCorrected = tvPdTotalCorregidoValue
            this@ComprensionFragmentE10M4.tvComprehensionLevel = tvNivelComprensionValue
            this@ComprensionFragmentE10M4.tvPercentile = tvPercentilValue
            tvLevel = tvNivelObtenidoValue
            this@ComprensionFragmentE10M4.tvCalculatedDeviation = tvDesviacionCalculadaValue
