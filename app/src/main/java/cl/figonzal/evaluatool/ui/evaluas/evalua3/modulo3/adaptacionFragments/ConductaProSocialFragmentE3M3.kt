...
import cl.figonzal.evaluatool.domain.resolvers.evalua3.modulo3.ConductaProSocialFragmentE3M3Resolver.Companion.DEVIATION
import cl.figonzal.evaluatool.domain.resolvers.evalua3.modulo3.ConductaProSocialFragmentE3M3Resolver.Companion.MEAN
...
class ConductaProSocialFragmentE3M3 : Fragment() {
    ...
    private var _binding: FragmentConductaProSocialE3M3Binding? = null
    ...
    private val resolver: ConductaProSocialFragmentE3M3Resolver by inject()

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View {
        _binding = FragmentConductaProSocialE3M3Binding.inflate(inflater, container, false)
    ...
    private fun initResources(binding: FragmentConductaProSocialE3M3Binding) {
        ...
        with(binding) {
            ...
            this@ConductaProSocialFragmentE3M3.etApprovedT1 = etAprobadasT1
