...
import cl.figonzal.evaluatool.domain.resolvers.evalua4.modulo3.AutoEstimaFragmentE4M3Resolver.Companion.DEVIATION
import cl.figonzal.evaluatool.domain.resolvers.evalua4.modulo3.AutoEstimaFragmentE4M3Resolver.Companion.MEAN
...
class AutoEstimaFragmentE4M3 : Fragment() {

    companion object {

        fun newInstance(): AutoEstimaFragmentE4M3 {
            return AutoEstimaFragmentE4M3()
        }
    }

    private var _binding: FragmentAutoEstimaE4M3Binding? = null
    ...
    private val resolver: AutoEstimaFragmentE4M3Resolver by inject()
    ...
    override fun onCreateView(
        ...
        _binding = FragmentAutoEstimaE4M3Binding.inflate(inflater, container, false)
    ...
    private fun initResources(binding: FragmentAutoEstimaE4M3Binding) {
        ...
        with(binding) {
            ...
            this@AutoEstimaFragmentE4M3.etApprovedT1 = etAprobadasT1

            //TOTAL
            this@AutoEstimaFragmentE4M3.tvPdTotal = tvPdTotalValue
