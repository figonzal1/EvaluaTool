...
class FragmentStateAdapterE4M3(fa: FragmentActivity) : FragmentStateAdapter(fa) {
    ...
    override fun createFragment(position: Int): Fragment {
        return when (position) {
            ...
            1 -> MotivacionFragmentE4M3.newInstance()
            2 -> AutoControlFragmentE4M3.newInstance()
            3 -> ConductaProSocialFragmentE4M3.newInstance()
            4 -> AutoEstimaFragmentE4M3.newInstance()
