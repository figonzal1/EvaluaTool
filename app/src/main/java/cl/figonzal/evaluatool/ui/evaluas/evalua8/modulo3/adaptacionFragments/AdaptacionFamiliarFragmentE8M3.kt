...
import cl.figonzal.evaluatool.domain.resolvers.evalua8.modulo3.AdaptacionFamiliarFragmentE8M3Resolver.Companion.MEAN
...
class AdaptacionFamiliarFragmentE8M3 : Fragment() {
    ...
    private var _binding: FragmentAdaptacionFamiliarE8M3Binding? = null
    ...
    private val resolver: AdaptacionFamiliarFragmentE8M3Resolver by inject()
    ...
    override fun onCreateView(
        ...
        _binding = FragmentAdaptacionFamiliarE8M3Binding.inflate(inflater, container, false)
    ...
    private fun initResources(binding: FragmentAdaptacionFamiliarE8M3Binding) {
        ...
        with(binding) {
            ...
            this@AdaptacionFamiliarFragmentE8M3.etApprovedT1 = etAprobadasT1

            //TOTAL
            this@AdaptacionFamiliarFragmentE8M3.tvPdTotal = tvPdTotalValue
            tvPdCorrected = tvPdTotalCorregidoValue
            this@AdaptacionFamiliarFragmentE8M3.tvPercentile = tvPercentilValue
