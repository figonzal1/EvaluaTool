...
import cl.figonzal.evaluatool.domain.resolvers.evalua5.modulo4.VelocidadFragmentE5M4Resolver.Companion.DEVIATION
import cl.figonzal.evaluatool.domain.resolvers.evalua5.modulo4.VelocidadFragmentE5M4Resolver.Companion.MEAN
...
class VelocidadFragmentE5M4 : Fragment() {
    ...
    private var _binding: FragmentVelocidadE5M4Binding? = null
    ...
    private val resolver: VelocidadFragmentE5M4Resolver by inject()
    ...
    override fun onCreateView(
        ...
        _binding = FragmentVelocidadE5M4Binding.inflate(inflater, container, false)
    ...
    private fun initResources(binding: FragmentVelocidadE5M4Binding) {
        ...
        with(binding) {
            ...
            this@VelocidadFragmentE5M4.etSecondsT1 = etSegundosT1
