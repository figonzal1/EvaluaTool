...
import cl.figonzal.evaluatool.domain.resolvers.evalua8.modulo3.HabilidadesSocialesFragmentE8M3Resolver.Companion.MEAN
...
class HabilidadesSocialesFragmentE8M3 : Fragment() {
    ...
    companion object {
        fun newInstance(): HabilidadesSocialesFragmentE8M3 {
            return HabilidadesSocialesFragmentE8M3()
        }
    }

    private var _binding: FragmentHabilidadesSocialesE8M3Binding? = null
    ...
    private val resolver: HabilidadesSocialesFragmentE8M3Resolver by inject()
    ...
    override fun onCreateView(
        ...
        _binding = FragmentHabilidadesSocialesE8M3Binding.inflate(inflater, container, false)

        initResources(binding)
        return binding.root
    }

    private fun initResources(binding: FragmentHabilidadesSocialesE8M3Binding) {
