...
import cl.figonzal.evaluatool.domain.resolvers.evalua2.modulo3.AutoControlFragmentE2M3Resolver.Companion.DEVIATION
import cl.figonzal.evaluatool.domain.resolvers.evalua2.modulo3.AutoControlFragmentE2M3Resolver.Companion.MEAN
...
class AutoControlFragmentE2M3 : Fragment() {

    companion object {
        fun newInstance(): AutoControlFragmentE2M3 {
            return AutoControlFragmentE2M3()
        }
    }

    private var _binding: FragmentAutoControlE2M3Binding? = null
    ...
    private val resolver: AutoControlFragmentE2M3Resolver by inject()
    ...
    override fun onCreateView(
        ...
        _binding = FragmentAutoControlE2M3Binding.inflate(inflater, container, false)

        initResources(binding)
        return binding.root
    }

    private fun initResources(binding: FragmentAutoControlE2M3Binding) {
        ...
        with(binding) {
            ...
            this@AutoControlFragmentE2M3.etApprovedT1 = etAprobadasT1

            //TOTAL
            this@AutoControlFragmentE2M3.tvPdTotal = tvPdTotalValue
