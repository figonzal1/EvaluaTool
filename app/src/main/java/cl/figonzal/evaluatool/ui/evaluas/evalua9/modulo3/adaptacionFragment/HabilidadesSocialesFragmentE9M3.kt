...
import cl.figonzal.evaluatool.domain.resolvers.evalua9.modulo3.HabilidadesSocialesFragmentE9M3Resolver.Companion.MEAN
...
class HabilidadesSocialesFragmentE9M3 : Fragment() {
    ...
    private var _binding: FragmentHabilidadesSocialesE9M3Binding? = null
    ...
    private val resolver: HabilidadesSocialesFragmentE9M3Resolver by inject()
    ...
    override fun onCreateView(
        ...
        _binding = FragmentHabilidadesSocialesE9M3Binding.inflate(inflater, container, false)
    ...
    private fun initResources(binding: FragmentHabilidadesSocialesE9M3Binding) {
        ...
        with(binding) {
            ...
            this@HabilidadesSocialesFragmentE9M3.etApprovedT1 = etAprobadasT1

            //TOTAL
            this@HabilidadesSocialesFragmentE9M3.tvPdTotal = tvPdTotalValue
            tvPdCorrected = tvPdTotalCorregidoValue
            this@HabilidadesSocialesFragmentE9M3.tvPercentile = tvPercentilValue
