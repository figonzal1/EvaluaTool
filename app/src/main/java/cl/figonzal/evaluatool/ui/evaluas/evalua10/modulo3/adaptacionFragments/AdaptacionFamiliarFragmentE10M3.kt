...
import cl.figonzal.evaluatool.domain.resolvers.evalua10.modulo3.AdaptacionFamiliarFragmentE10M3Resolver.Companion.DEVIATION
import cl.figonzal.evaluatool.domain.resolvers.evalua10.modulo3.AdaptacionFamiliarFragmentE10M3Resolver.Companion.MEAN
...
class AdaptacionFamiliarFragmentE10M3 : Fragment() {
    ...
    private var _binding: FragmentAdaptacionFamiliarE10M3Binding? = null
    ...
    private val resolver: AdaptacionFamiliarFragmentE10M3Resolver by inject()
    ...
    override fun onCreateView(
        ...
        _binding = FragmentAdaptacionFamiliarE10M3Binding.inflate(inflater, container, false)
    ...
    private fun initResources(binding: FragmentAdaptacionFamiliarE10M3Binding) {
        ...
        with(binding) {
            ...
            this@AdaptacionFamiliarFragmentE10M3.etApprovedT1 = etAprobadasT1

            //TOTAL
            this@AdaptacionFamiliarFragmentE10M3.tvPdTotal = tvPdTotalValue
            tvPdCorrected = cardViewFinal.tvPdTotalCorregidoValue
            this@AdaptacionFamiliarFragmentE10M3.tvPercentile = cardViewFinal.tvPercentilValue
