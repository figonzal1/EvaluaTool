...
import cl.figonzal.evaluatool.domain.resolvers.evalua3.modulo3.AutoControlFragmentE3M3Resolver.Companion.DEVIATION
import cl.figonzal.evaluatool.domain.resolvers.evalua3.modulo3.AutoControlFragmentE3M3Resolver.Companion.MEAN
...
class AutoControlFragmentE3M3 : Fragment() {
    ...
    private var _binding: FragmentAutoControlE3M3Binding? = null
    ...
    private val resolver: AutoControlFragmentE3M3Resolver by inject()
    ...
    override fun onCreateView(
        ...
        _binding = FragmentAutoControlE3M3Binding.inflate(inflater, container, false)
    ...
    private fun initResources(binding: FragmentAutoControlE3M3Binding) {
        ...
        with(binding) {
            ...
            this@AutoControlFragmentE3M3.etApprovedT1 = etAprobadasT1
