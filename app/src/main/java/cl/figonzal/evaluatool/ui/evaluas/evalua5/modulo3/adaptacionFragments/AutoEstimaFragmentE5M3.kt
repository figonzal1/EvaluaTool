...
import cl.figonzal.evaluatool.databinding.FragmentAutoEstimaE5M3Binding
import cl.figonzal.evaluatool.domain.resolvers.evalua5.modulo3.AutoEstimaFragmentE5M3Resolver
import cl.figonzal.evaluatool.domain.resolvers.evalua5.modulo3.AutoEstimaFragmentE5M3Resolver.Companion.DEVIATION
import cl.figonzal.evaluatool.domain.resolvers.evalua5.modulo3.AutoEstimaFragmentE5M3Resolver.Companion.MEAN
...
class AutoEstimaFragmentE5M3 : Fragment() {

    companion object {
        fun newInstance(): AutoEstimaFragmentE5M3 {
            return AutoEstimaFragmentE5M3()
        }
    }

    private var _binding: FragmentAutoEstimaE5M3Binding? = null
    ...
    private val resolver: AutoEstimaFragmentE5M3Resolver by inject()
    ...
    override fun onCreateView(
        ...
        _binding = FragmentAutoEstimaE5M3Binding.inflate(inflater, container, false)

        initResources(binding)
        return binding.root
    }

    private fun initResources(binding: FragmentAutoEstimaE5M3Binding) {
        ...
        with(binding) {
            ...
            this@AutoEstimaFragmentE5M3.etApprovedT1 = etAprobadasT1

            //TOTAL
            this@AutoEstimaFragmentE5M3.tvPdTotal = tvPdTotalValue
