...
import cl.figonzal.evaluatool.domain.resolvers.evalua7.modulo5.ExpresionEscritaE7M5Resolver.Companion.DEVIATION
import cl.figonzal.evaluatool.domain.resolvers.evalua7.modulo5.ExpresionEscritaE7M5Resolver.Companion.MEAN
...
class ExpresionEscritaE7M5 : AppCompatActivity() {
    ...
    private val resolver: ExpresionEscritaE7M5Resolver by inject()
    ...
    private fun initResources() {
        ...
        with(binding) {
            ...
            this@ExpresionEscritaE7M5.etApprovedT1 = etAprobadasT1
            ...
            progressBar.max = resolver.percentile.last()[1].toInt()
