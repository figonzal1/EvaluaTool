...
import cl.figonzal.evaluatool.domain.resolvers.evalua2.modulo4.ComprensionLectoraE2M4Resolver.Companion.DEVIATION
import cl.figonzal.evaluatool.domain.resolvers.evalua2.modulo4.ComprensionLectoraE2M4Resolver.Companion.MEAN
...
class ComprensionLectoraE2M4 : AppCompatActivity() {
    ...
    //TAREA 3
    private lateinit var etApproveT3: TextInputEditText
    private var approveT3 = 0
    ...
    private val resolver: ComprensionLectoraE2M4Resolver by inject()
    ...
    private fun initResources() {
        ...
        with(binding) {
            ...
            this@ComprensionLectoraE2M4.etApprovedT1 = etAprobadasT1
            this@ComprensionLectoraE2M4.etReprobateT1 = etReprobadasT1

            //TAREA 2
            tvSubTotalT2 = tvPdSubtotalT2
            this@ComprensionLectoraE2M4.etApprovedT2 = etAprobadasT2
            this@ComprensionLectoraE2M4.etReprobateT2 = etReprobadasT2

            //TAREA 3
            tvSubTotalT3 = tvPdSubtotalT3
            this@ComprensionLectoraE2M4.etApproveT3 = etAprobadasT3

            //TOTAL
            this@ComprensionLectoraE2M4.tvPdTotal = tvPdTotalValue
        ...
        etApproveT3.run {
            addTextChangedListener(object : TextWatcher {
                ...
                override fun afterTextChanged(s: Editable) {
                    ...
                    when {
                        s.isEmpty() -> approveT3 = 0
                        s.isNotEmpty() -> approveT3 = text.toString().toInt()
                    }
                    with(
                        resolver.calculateTask(
                            nTask = 3,
