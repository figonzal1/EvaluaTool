...
import cl.figonzal.evaluatool.domain.resolvers.evalua8.modulo4.ComprensionFragmentE8M4Resolver.Companion.DEVIATION
import cl.figonzal.evaluatool.domain.resolvers.evalua8.modulo4.ComprensionFragmentE8M4Resolver.Companion.MEAN
...
class ComprensionFragmentE8M4 : Fragment() {
    ...
    private var _binding: FragmentComprensionE8M4Binding? = null
    ...
    private val resolver: ComprensionFragmentE8M4Resolver by inject()

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View {
        _binding = FragmentComprensionE8M4Binding.inflate(inflater, container, false)
    ...
    private fun initResources(binding: FragmentComprensionE8M4Binding) {
        ...
        with(binding) {
            ...
            this@ComprensionFragmentE8M4.etApprovedT1 = etAprobadasT1
            this@ComprensionFragmentE8M4.etOmittedT1 = etOmitidasT1
            this@ComprensionFragmentE8M4.etReprobateT1 = etReprobadasT1

            //TOTAL
            this@ComprensionFragmentE8M4.tvPdTotal = tvPdTotalValue
            tvPdCorrected = tvPdTotalCorregidoValue
            this@ComprensionFragmentE8M4.tvComprehensionLevel = tvNivelComprensionValue
            this@ComprensionFragmentE8M4.tvPercentile = tvPercentilValue
            tvLevel = tvNivelObtenidoValue
            this@ComprensionFragmentE8M4.tvCalculatedDeviation = tvDesviacionCalculadaValue
