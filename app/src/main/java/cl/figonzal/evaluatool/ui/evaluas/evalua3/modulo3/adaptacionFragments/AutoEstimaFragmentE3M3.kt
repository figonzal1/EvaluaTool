...
import cl.figonzal.evaluatool.databinding.FragmentAutoEstimaE3M3Binding
import cl.figonzal.evaluatool.domain.resolvers.evalua3.modulo3.AutoEstimaFragmentE3M3Resolver
import cl.figonzal.evaluatool.domain.resolvers.evalua3.modulo3.AutoEstimaFragmentE3M3Resolver.Companion.DEVIATION
import cl.figonzal.evaluatool.domain.resolvers.evalua3.modulo3.AutoEstimaFragmentE3M3Resolver.Companion.MEAN
...
class AutoEstimaFragmentE3M3 : Fragment() {

    companion object {
        fun newInstance(): AutoEstimaFragmentE3M3 {
            return AutoEstimaFragmentE3M3()
        }
    }

    private var _binding: FragmentAutoEstimaE3M3Binding? = null
    ...
    private val resolver: AutoEstimaFragmentE3M3Resolver by inject()
    ...
    override fun onCreateView(
        ...
        _binding = FragmentAutoEstimaE3M3Binding.inflate(inflater, container, false)

        initResources(binding)
        return binding.root
    }

    private fun initResources(binding: FragmentAutoEstimaE3M3Binding) {
        ...
        with(binding) {
            ...
            this@AutoEstimaFragmentE3M3.etApprovedT1 = etAprobadasT1

            //TOTAL
            this@AutoEstimaFragmentE3M3.tvPdTotal = tvPdTotalValue
