...
import cl.figonzal.evaluatool.ui.evaluas.evalua10.modulo3.adaptacionFragments.FragmentStateAdapterE10M3
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        with(binding) {
            ...
            viewPagerNivelesAdaptacion.adapter =
                FragmentStateAdapterE10M3(this@NivelesAdaptacionE10M3)
            setTabs()
        }
    }
    ...
    private fun setTabs() {
        ...
        with(binding) {
            ...
            TabLayoutMediator(
                ...
                tab.text = FragmentStateAdapterE10M3.tabsArray[position]
