...
import cl.figonzal.evaluatool.domain.resolvers.evalua1.modulo3.MotivacionFragmentE1M3Resolver.Companion.DEVIATION
import cl.figonzal.evaluatool.domain.resolvers.evalua1.modulo3.MotivacionFragmentE1M3Resolver.Companion.MEAN
...
class MotivacionFragmentE1M3 : Fragment() {
    ...
    private var _binding: FragmentMotivacionE1M3Binding? = null
    ...
    private val resolver: MotivacionFragmentE1M3Resolver by inject()
    ...
    override fun onCreateView(
        ...
        _binding = FragmentMotivacionE1M3Binding.inflate(inflater, container, false)
    ...
    private fun initResources(binding: FragmentMotivacionE1M3Binding) {
        ...
        with(binding) {
            ...
            this@MotivacionFragmentE1M3.etApprovedT1 = etAprobadasT1
