...
import cl.figonzal.evaluatool.domain.resolvers.evalua4.modulo3.MotivacionFragmentE4M3Resolver.Companion.DEVIATION
import cl.figonzal.evaluatool.domain.resolvers.evalua4.modulo3.MotivacionFragmentE4M3Resolver.Companion.MEAN
...
class MotivacionFragmentE4M3 : Fragment() {
    ...
    private var _binding: FragmentMotivacionE4M3Binding? = null
    ...
    private val resolver: MotivacionFragmentE4M3Resolver by inject()
    ...
    override fun onCreateView(
        ...
        _binding = FragmentMotivacionE4M3Binding.inflate(inflater, container, false)
    ...
    private fun initResources(binding: FragmentMotivacionE4M3Binding) {
        ...
        with(binding) {
            ...
            this@MotivacionFragmentE4M3.etApprovedT1 = etAprobadasT1
