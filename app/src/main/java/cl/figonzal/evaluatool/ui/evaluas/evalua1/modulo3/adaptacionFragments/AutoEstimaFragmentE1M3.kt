...
import cl.figonzal.evaluatool.domain.resolvers.evalua1.modulo3.AutoEstimaFragmentE1M3Resolver.Companion.DEVIATION
import cl.figonzal.evaluatool.domain.resolvers.evalua1.modulo3.AutoEstimaFragmentE1M3Resolver.Companion.MEAN
...
class AutoEstimaFragmentE1M3 : Fragment() {
    ...
    private var _binding: FragmentAutoEstimaE1M3Binding? = null
    ...
    private val resolver: AutoEstimaFragmentE1M3Resolver by inject()
    ...
    override fun onCreateView(
        ...
        _binding = FragmentAutoEstimaE1M3Binding.inflate(inflater, container, false)
