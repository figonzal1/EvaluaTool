...
import cl.figonzal.evaluatool.domain.resolvers.evalua5.modulo4.ComprensionFragmentE5M4Resolver.Companion.DEVIATION
import cl.figonzal.evaluatool.domain.resolvers.evalua5.modulo4.ComprensionFragmentE5M4Resolver.Companion.MEAN
...
class ComprensionFragmentE5M4 : Fragment() {
    ...
    private var _binding: FragmentComprensionE5M4Binding? = null
    ...
    private val resolver: ComprensionFragmentE5M4Resolver by inject()
    ...
    override fun onCreateView(
        ...
        _binding = FragmentComprensionE5M4Binding.inflate(inflater, container, false)
