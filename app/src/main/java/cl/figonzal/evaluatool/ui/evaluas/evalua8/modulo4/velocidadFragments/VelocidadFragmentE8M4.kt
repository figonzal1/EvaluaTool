...
import cl.figonzal.evaluatool.domain.resolvers.evalua8.modulo4.VelocidadFragmentE8M4Resolver.Companion.DEVIATION
import cl.figonzal.evaluatool.domain.resolvers.evalua8.modulo4.VelocidadFragmentE8M4Resolver.Companion.MEAN
...
class VelocidadFragmentE8M4 : Fragment() {
    ...
    private var _binding: FragmentVelocidadE8M4Binding? = null
    ...
    private val resolver: VelocidadFragmentE8M4Resolver by inject()

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View {
        _binding = FragmentVelocidadE8M4Binding.inflate(inflater, container, false)
    ...
    private fun initResources(binding: FragmentVelocidadE8M4Binding) {
        ...
        with(binding) {
            ...
            this@VelocidadFragmentE8M4.etSecondsT1 = etSegundosT1
