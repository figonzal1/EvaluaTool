...
import cl.figonzal.evaluatool.domain.resolvers.evalua6.modulo4.VelocidadFragmentE6M4Resolver.Companion.DEVIATION
import cl.figonzal.evaluatool.domain.resolvers.evalua6.modulo4.VelocidadFragmentE6M4Resolver.Companion.MEAN
...
class VelocidadFragmentE6M4 : Fragment() {
    ...
    private var _binding: FragmentVelocidadE6M4Binding? = null
    ...
    private val resolver: VelocidadFragmentE6M4Resolver by inject()
    ...
    override fun onCreateView(
        ...
        _binding = FragmentVelocidadE6M4Binding.inflate(inflater, container, false)
    ...
    private fun initResources(binding: FragmentVelocidadE6M4Binding) {
        ...
        with(binding) {
            ...
            this@VelocidadFragmentE6M4.etSecondsT1 = etSegundosT1
