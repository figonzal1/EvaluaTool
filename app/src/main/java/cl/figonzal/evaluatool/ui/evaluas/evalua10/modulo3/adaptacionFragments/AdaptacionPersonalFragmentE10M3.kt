...
import cl.figonzal.evaluatool.domain.resolvers.evalua10.modulo3.AdaptacionPersonalFragmentE10M3Resolver.Companion.DEVIATION
import cl.figonzal.evaluatool.domain.resolvers.evalua10.modulo3.AdaptacionPersonalFragmentE10M3Resolver.Companion.MEAN
...
class AdaptacionPersonalFragmentE10M3 : Fragment() {
    ...
    private var _binding: FragmentAdaptacionPersonalE10M3Binding? = null
    ...
    private val resolver: AdaptacionPersonalFragmentE10M3Resolver by inject()
    ...
    override fun onCreateView(
        ...
        _binding = FragmentAdaptacionPersonalE10M3Binding.inflate(inflater, container, false)
