...
import cl.figonzal.evaluatool.domain.resolvers.evalua8.modulo3.AdaptacionEscolarFragmentE8M3Resolver.Companion.MEAN
...
class AdaptacionEscolarFragmentE8M3 : Fragment() {
    ...
    private var _binding: FragmentAdaptacionEscolarE8M3Binding? = null
    ...
    private val resolver: AdaptacionEscolarFragmentE8M3Resolver by inject()
    ...
    override fun onCreateView(
        ...
        _binding = FragmentAdaptacionEscolarE8M3Binding.inflate(inflater, container, false)
    ...
    private fun initResources(binding: FragmentAdaptacionEscolarE8M3Binding) {
        ...
        with(binding) {
            ...
            this@AdaptacionEscolarFragmentE8M3.etApprovedT1 = etAprobadasT1

            //TOTAL
            this@AdaptacionEscolarFragmentE8M3.tvPdTotal = tvPdTotalValue
            tvPdCorrected = tvPdTotalCorregidoValue
            this@AdaptacionEscolarFragmentE8M3.tvPercentile = tvPercentilValue
