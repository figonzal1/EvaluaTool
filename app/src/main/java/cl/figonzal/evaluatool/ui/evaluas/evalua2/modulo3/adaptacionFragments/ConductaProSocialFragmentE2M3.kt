...
import cl.figonzal.evaluatool.domain.resolvers.evalua2.modulo3.ConductaProSocialFragmentE2M3Resolver.Companion.DEVIATION
import cl.figonzal.evaluatool.domain.resolvers.evalua2.modulo3.ConductaProSocialFragmentE2M3Resolver.Companion.MEAN
...
class ConductaProSocialFragmentE2M3 : Fragment() {
    ...
    private var _binding: FragmentConductaProSocialE2M3Binding? = null
    ...
    private val resolver: ConductaProSocialFragmentE2M3Resolver by inject()
    ...
    override fun onCreateView(
        ...
        _binding = FragmentConductaProSocialE2M3Binding.inflate(inflater, container, false)
    ...
    private fun initResources(binding: FragmentConductaProSocialE2M3Binding) {
        ...
        with(binding) {
            ...
            this@ConductaProSocialFragmentE2M3.etApprovedT1 = etAprobadasT1
