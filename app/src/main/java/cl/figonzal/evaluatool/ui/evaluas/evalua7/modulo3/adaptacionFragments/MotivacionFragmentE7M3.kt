...
import cl.figonzal.evaluatool.domain.resolvers.evalua7.modulo3.MotivacionFragmentE7M3Resolver.Companion.DEVIATION
import cl.figonzal.evaluatool.domain.resolvers.evalua7.modulo3.MotivacionFragmentE7M3Resolver.Companion.MEAN
...
class MotivacionFragmentE7M3 : Fragment() {
    ...
    private var _binding: FragmentMotivacionE7M3Binding? = null
    ...
    private val resolver: MotivacionFragmentE7M3Resolver by inject()
    ...
    override fun onCreateView(
        ...
        _binding = FragmentMotivacionE7M3Binding.inflate(inflater, container, false)
    ...
    private fun initResources(binding: FragmentMotivacionE7M3Binding) {
        ...
        with(binding) {
            ...
            this@MotivacionFragmentE7M3.etApprovedT1 = etAprobadasT1
