...
import cl.figonzal.evaluatool.domain.resolvers.evalua5.modulo3.AutoControlFragmentE5M3Resolver.Companion.DEVIATION
import cl.figonzal.evaluatool.domain.resolvers.evalua5.modulo3.AutoControlFragmentE5M3Resolver.Companion.MEAN
...
class AutoControlFragmentE5M3 : Fragment() {
    ...
    private var _binding: FragmentAutoControlE5M3Binding? = null
    ...
    private val resolver: AutoControlFragmentE5M3Resolver by inject()
    ...
    override fun onCreateView(
        ...
        _binding = FragmentAutoControlE5M3Binding.inflate(inflater, container, false)
    ...
    private fun initResources(binding: FragmentAutoControlE5M3Binding) {
        ...
        with(binding) {
            ...
            this@AutoControlFragmentE5M3.etApprovedT1 = etAprobadasT1
