...
import cl.figonzal.evaluatool.domain.resolvers.evalua4.modulo4.ComprensionFragmentE4M4Resolver.Companion.DEVIATION
import cl.figonzal.evaluatool.domain.resolvers.evalua4.modulo4.ComprensionFragmentE4M4Resolver.Companion.MEAN
...
class ComprensionFragmentE4M4 : Fragment() {
    ...
    private var _binding: FragmentComprensionE4M4Binding? = null
    ...
    private val resolver: ComprensionFragmentE4M4Resolver by inject()
    ...
    override fun onCreateView(
        ...
        _binding = FragmentComprensionE4M4Binding.inflate(inflater, container, false)
    ...
    private fun initResources(binding: FragmentComprensionE4M4Binding) {
        ...
        with(binding) {
            ...
            this@ComprensionFragmentE4M4.etApprovedT1 = etAprobadasT1
            this@ComprensionFragmentE4M4.etOmittedT1 = etOmitidasT1
            this@ComprensionFragmentE4M4.etReprobateT1 = etReprobadasT1

            //TOTAL
            this@ComprensionFragmentE4M4.tvPdTotal = tvPdTotalValue
            tvPdCorrected = tvPdTotalCorregidoValue
            this@ComprensionFragmentE4M4.tvPercentile = tvPercentilValue
            tvLevel = tvNivelObtenidoValue
            this@ComprensionFragmentE4M4.tvCalculatedDeviation = tvDesviacionCalculadaValue
