...
import cl.figonzal.evaluatool.domain.resolvers.evalua4.modulo3.ConductaProSocialFragmentE4M3Resolver.Companion.DEVIATION
import cl.figonzal.evaluatool.domain.resolvers.evalua4.modulo3.ConductaProSocialFragmentE4M3Resolver.Companion.MEDIA
...
class ConductaProSocialFragmentE4M3 : Fragment() {
    ...
    private val resolver: ConductaProSocialFragmentE4M3Resolver by inject()
    ...
    private fun calculateResult() {
        ...
        resolver.run {
            ...
            tvCalculatedDeviation.text =
                EvaluaUtils.calculateDeviation(MEDIA, DEVIATION, pdCorrected, reverse = true)
