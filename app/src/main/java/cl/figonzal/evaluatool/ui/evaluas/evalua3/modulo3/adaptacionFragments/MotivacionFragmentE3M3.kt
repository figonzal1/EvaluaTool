...
import cl.figonzal.evaluatool.domain.resolvers.evalua3.modulo3.MotivacionFragmentE3M3Resolver.Companion.DEVIATION
import cl.figonzal.evaluatool.domain.resolvers.evalua3.modulo3.MotivacionFragmentE3M3Resolver.Companion.MEAN
...
class MotivacionFragmentE3M3 : Fragment() {
    ...
    private var _binding: FragmentMotivacionE3M3Binding? = null
    ...
    private val resolver: MotivacionFragmentE3M3Resolver by inject()
    ...
    override fun onCreateView(
        ...
        _binding = FragmentMotivacionE3M3Binding.inflate(inflater, container, false)
    ...
    private fun initResources(binding: FragmentMotivacionE3M3Binding) {
        ...
        with(binding) {
            ...
            this@MotivacionFragmentE3M3.etApprovedT1 = etAprobadasT1
