...
import cl.figonzal.evaluatool.domain.resolvers.evalua1.modulo3.AutoControlFragmentE1M3Resolver.Companion.DEVIATION
import cl.figonzal.evaluatool.domain.resolvers.evalua1.modulo3.AutoControlFragmentE1M3Resolver.Companion.MEAN
...
class AutoControlFragmentE1M3 : Fragment() {
    ...
    private var _binding: FragmentAutoControlE1M3Binding? = null
    ...
    private val resolver: AutoControlFragmentE1M3Resolver by inject()
    ...
    override fun onCreateView(
        ...
        _binding = FragmentAutoControlE1M3Binding.inflate(inflater, container, false)
    ...
    private fun initResources(binding: FragmentAutoControlE1M3Binding) {
        ...
        with(binding) {
            ...
            this@AutoControlFragmentE1M3.etApprovedT1 = etAprobadasT1

            //TOTAL
            this@AutoControlFragmentE1M3.tvPdTotal = tvPdTotalValue
