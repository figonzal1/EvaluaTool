...
public class OrtografiaVisualReglada extends AppCompatActivity implements EvaluaInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.setTitle(getString(R.string.TOOLBAR_ORT_VIS_REGLADA));
    ...
    private void textWatcherTarea1() {
        ...
        et_aprobadas_t1.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                total_pd_t1 = calcularTarea(1, tv_sub_total_t1, "Tarea 1: ", aprobadas_t1, omitidas_t1, reprobadas_t1);
                calcularResultado();
            }
        });
    ...
    private void textWatcherTarea2() {
        et_aprobadas_t2.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                total_pd_t2 = calcularTarea(2, tv_sub_total_t2, "Tarea 2: ", aprobadas_t2, omitidas_t2, reprobadas_t2);
                calcularResultado();
            }
        });
    ...
    public double calcularTarea(Integer n_tarea, TextView tv_sub_total, String tarea, Integer aprobadas, Integer omitidas, Integer reprobadas) {
        ...
        if (n_tarea == 1) {
            ...
            total = 3 * (aprobadas - (reprobadas + omitidas));
            total = Math.floor(total);
        }
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        if (item.getItemId() == android.R.id.home) {
            Log.d(getString(R.string.TAG_ORT_VIS_REGLADA), getString(R.string.ACTIVIDAD_CERRADA));

            Crashlytics.log(Log.DEBUG, getString(R.string.TAG_ORT_VIS_REGLADA), getString(R.string.ACTIVIDAD_CERRADA));
