...
public class ComprensionFragment extends Fragment implements EvaluaInterface {

    private static final double DESVIACION = 3.02;
    private static final double MEDIA = 6.25;
    ...
    public ComprensionFragment() {
        // Required empty public constructor
    }

    static ComprensionFragment newInstance() {
        return new ComprensionFragment();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_comprension, container, false);
    ...
    private String calcularComprension(double pd_actual) {
        ...
        Crashlytics.log(Log.DEBUG, getString(R.string.TAG_COMPRENSION_CALCULADA), getString(R.string.COMPRENSION_NULA));
        return null;
    }
}
