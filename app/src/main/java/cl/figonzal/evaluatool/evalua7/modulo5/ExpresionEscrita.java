...
public class ExpresionEscrita extends AppCompatActivity implements EvaluaInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_expresion_escrita);
        ...
        actionBar.setTitle(getString(R.string.TOOLBAR_EXPRESION_ESCRITA));
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        if (item.getItemId() == android.R.id.home) {
            Log.d(getString(R.string.TAG_EXP_ESCRITA), getString(R.string.ACTIVIDAD_CERRADA));

            Crashlytics.log(Log.DEBUG, getString(R.string.TAG_EXP_ESCRITA), getString(R.string.ACTIVIDAD_CERRADA));
