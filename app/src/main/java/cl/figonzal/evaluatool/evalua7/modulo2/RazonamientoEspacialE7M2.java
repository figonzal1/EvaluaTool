...
public class RazonamientoEspacialE7M2 extends AppCompatActivity implements EvaluaInterface {
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        if (item.getItemId() == android.R.id.home) {
            ...
            crashlytics.log(getString(R.string.TAG_RAZON_ESPACIAL) + getString(R.string.ACTIVIDAD_CERRADA));
