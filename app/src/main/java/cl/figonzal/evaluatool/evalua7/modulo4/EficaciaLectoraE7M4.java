...
public class EficaciaLectoraE7M4 extends AppCompatActivity implements EvaluaInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_eficacia_lectora_e7_m4);
        ...
        actionBar.setTitle(getString(R.string.TOOLBAR_EFICACIA_LECTORA));
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        if (item.getItemId() == android.R.id.home) {
            Log.d(getString(R.string.TAG_EFICACIA_LECTORA), getString(R.string.ACTIVIDAD_CERRADA));

            crashlytics.log(getString(R.string.TAG_EFICACIA_LECTORA) + getString(R.string.ACTIVIDAD_CERRADA));
