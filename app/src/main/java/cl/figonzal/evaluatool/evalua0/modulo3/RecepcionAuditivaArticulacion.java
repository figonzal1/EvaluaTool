...
public class RecepcionAuditivaArticulacion extends AppCompatActivity implements EvaluaInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_recepcion_autitiva_articulacion);
        ...
        actionBar.setTitle(getString(R.string.TOOLBAR_RECEPCION_AUDITIVA));
    ...
    private void textWatcherTarea1() {
        et_aprobadas_t1.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                subtotal_pd_t1 = calcularTarea(1, tv_sub_total_t1, "Tarea 1: ", aprobadas_t1, null, null);
                calcularResultado();
            }
        });
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        if (item.getItemId() == android.R.id.home) {
            Log.d(getString(R.string.TAG_RECEPCION_AUDITIVA), getString(R.string.ACTIVIDAD_CERRADA));

            Crashlytics.log(Log.DEBUG, getString(R.string.TAG_RECEPCION_AUDITIVA), getString(R.string.ACTIVIDAD_CERRADA));
