...
public class MemoriaVerbal extends AppCompatActivity implements EvaluaInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_memoria_verbal);
        ...
        actionBar.setTitle(getString(R.string.TOOLBAR_MEMORIA_VERBAL));
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        if (item.getItemId() == android.R.id.home) {
            ...
            Log.d(getString(R.string.TAG_MEMORIA_VERBAL), getString(R.string.ACTIVIDAD_CERRADA));

            Crashlytics.log(Log.DEBUG, getString(R.string.TAG_MEMORIA_VERBAL), getString(R.string.ACTIVIDAD_CERRADA));
